...
class DefinicionMigracionI2020Controller extends Controller
{
    ////

static public function I2020()
    {
   		//$F=DefinicionMigracionI2020Controller::I2020_INICIAL(54);
       	//$F=DefinicionMigracionI2020Controller::I2020_PRIMARIA(55);
       	//$F=DefinicionMigracionI2020Controller::I2020_SECUNDARIA(56);
       	//$F=DefinicionMigracionI2020Controller::I2020_SUPERIOR(57); 
		// $F=DefinicionMigracionI2020Controller::I2020_EPA(58); 
		$F=DefinicionMigracionI2020Controller::I2020_CENS(59);
		// $F=DefinicionMigracionI2020Controller::I2020_ESPECIAL(60); 
		// $F=DefinicionMigracionI2020Controller::I2020_ARTISTICA(61); 
		// $F=DefinicionMigracionI2020Controller::I2020_FP(62);
		// $F=DefinicionMigracionI2020Controller::I2020_CEC(63);        
		// $F=DefinicionMigracionI2020Controller::I2020_CEF(64);        
		// $F=DefinicionMigracionI2020Controller::I2020_CIIE(65);
...
$C->save_cuadro_migrador ([              'id_oferta_educativa'=>16,
										 'id_modalidad'=>804, //valor por defecto, si no se carga combo
										 'id_terminalidad_titulo'=>804000, //valor por defecto, si no se carga combo
										 'id_modo_de_dictado'=>2, //A Distancia/SemiPresencial     --6, // Virtual //cambio era 6 antes de inicial 2020
										 'id_caracteristica_matricula'=>1,
										 'id_anio_estudio'=>4,
										 'tabla_destino'=>'alumnos',
										 'campo_destino'=>'varon',
...
/*	
****
**** NO CORRESPONDE EN INICIAL 2020
****
