...
class DefinicionMigracionF2019Controller extends Controller
{
    ////

static public function F2019()
    {
   		// $F=DefinicionMigracionF2019Controller::F2019_INICIAL(42);
       	// $F=DefinicionMigracionF2019Controller::F2019_PRIMARIA(43);
       	// $F=DefinicionMigracionF2019Controller::F2019_SECUNDARIA(44);
       	// $F=DefinicionMigracionF2019Controller::F2019_SUPERIOR(45); 
		// $F=DefinicionMigracionF2019Controller::F2019_EPA(46); 
		// $F=DefinicionMigracionF2019Controller::F2019_CENS(47);
		$F=DefinicionMigracionF2019Controller::F2019_ESPECIAL(48); 
		// $F=DefinicionMigracionF2019Controller::F2019_ARTISTICA(49); 
		// $F=DefinicionMigracionF2019Controller::F2019_FP(50);
		// $F=DefinicionMigracionF2019Controller::F2019_CEC(51);        
		// $F=DefinicionMigracionF2019Controller::F2019_CEF(52);        
		// $F=DefinicionMigracionF2019Controller::F2019_CIIE(53);
...
/*
CUADRO 5 - OMITIDO / NO CORRESPONDE en relevamiento FINAL
...
// CUADRO 6) CANTIDAD DE ALUMNOS DE MODALIDAD VIRTUAL (Resolución Nº106/18)
$C=$F->cuadros[6];

$C->save_cuadro_migrador ([              'id_oferta_educativa'=>16,
										 'id_modalidad'=>804, //valor por defecto, si no se carga combo
										 'id_terminalidad_titulo'=>804000, //valor por defecto, si no se carga combo
										 'id_modo_de_dictado'=>6, // Virtual
										 'id_caracteristica_matricula'=>1,
										 'id_anio_estudio'=>4,
										 'tabla_destino'=>'alumnos',
										 'campo_destino'=>'varon',
...
// CUADRO 7) CANTIDAD DE SECCIONES SEGÚN MODO DE DICTADO Y AÑO
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>4,'id_tipo_seccion'=>'V'],  [ 'celdas'=> [[5,6]] ] );
...
// CUADRO 1) TURNOS DE FUNCIONAMIENTO
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','vista'=>'checkturnos','campo_destino'=>'','id_oferta_educativa'=>913,'id_personal'=>1,'id_turno'=>''],
											[ 'region'=> [[2,2,8,2]] ] );// M		
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=>'M'], [ 'celdas'=> [[2,2]]] );// M
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=>'I'], [ 'celdas'=> [[3,2]]] );// I
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=>'T'], [ 'celdas'=> [[4,2]]] );// T
...
// CUADRO 3) ALUMNOS MATRICULADOS EN LOS NIVELES INICIAL, PRIMARIO Y EN FORMACIÓN INTEGRAL (EN SEDE).
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>17,'id_modalidad'=>601 ],  [ 'region'=> [[4, 2,11, 3]] ] );  // N. inicial 1° Ciclo ATDI 0 A 3 AÑOS
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>18,'id_modalidad'=>602 ],  [ 'region'=> [[4, 4,11, 5]] ] );  // N. inicial 2° Ciclo
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>19,'id_modalidad'=>603 ],  [ 'region'=> [[4, 6,11, 9]] ] );  //n. primario
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>45,'id_modalidad'=>650 ],  [ 'region'=> [[4,10,11,13]] ] ); //n. Formación Integral (1) / secundario
    	...
    	$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>1],  [ 'region'=> [[4,2,11,3],[4,4,11,5],[4,6,11,7],[4,10,11,11]] ] );
    	$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>2],  [ 'region'=> [[4,8,11,9],[4,12,11,13]] ] );

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'campo_destino'=>'mujer'],  [ 'region'=> [[4,3,11,3],[4,5,11,5],[4,7,11,7],[4,9,11,9],[4,11,11,11],[4,13,11,13]] ] );
