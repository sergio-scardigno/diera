...
class DefinicionMigracionF2022Controller extends Controller
{
    ////
...
static public function F2022()
    {
		...
		// $F=DefinicionMigracionF2022Controller::F2022_ARTISTICA(121); 
		// $F=DefinicionMigracionF2022Controller::F2022_FP(122);
		// $F=DefinicionMigracionF2022Controller::F2022_CEC(123);        
		// $F=DefinicionMigracionF2022Controller::F2022_CEF(124);        
		// $F=DefinicionMigracionF2022Controller::F2022_CIIE(125);
...
// cuadro 10) NIVEL SECUNDARIO -   CANTIDAD DE ALUMNOS DE ITINERARIOS FORMATIVOS POR AÑO Y SEXO SEGÚN ITINERARIO FORMATIVO Y MODALIDAD
...
// cuadro 11) NIVEL SECUNDARIO -    CANTIDAD DE ALUMNOS DE CAPACITACIÓN POST-PRIMARIA (CEA, Cursos cortos de Oficio, etc.) POR AÑO Y SEXO SEGÚN CURSO
...
// CUADRO 12) NIVEL SECUNDARIO - CANTIDAD DE DIVISIONES / GRUPOS POR AÑO Y MODALIDAD
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones', 'id_oferta_educativa'=>9],  [ 'region'=> [[10,6,10,7]] ] ); // sist. dual
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones', 'id_oferta_educativa'=>64], [ 'region'=> [[11,5,11,8]] ] ); // IF
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones', 'id_oferta_educativa'=>12], [ 'region'=> [[12,2,12,4]] ] ); // Cursos de FP


        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>1],  [ 'region'=> [[2,2,12,2]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>2],  [ 'region'=> [[2,3,12,3]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>3],  [ 'region'=> [[2,4,12,4]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>4],  [ 'region'=> [[2,5,12,5]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>5],  [ 'region'=> [[2,6,12,6]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>6],  [ 'region'=> [[2,7,12,7]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>7],  [ 'region'=> [[2,8,12,8]] ] );
...
// CUADRO 14) CONFORMACIONES DE SECUNDARIAS	
		// NO SE MIGRA
		
		
// CUADRO 15) MATRÍCULA ATENDIDA DE MODALIDAD ARTÍSTICA Y ED. FÍSICA

		$C=$F->cuadros[15];
					// 'id_personal' = 1 personal propio / 2 de otro estab.
					//'id_servicio_complementario'= 5 Educación Física / 19 Plástica Visual / 20 Danza / 21 Música / 22 Teatro / 23 Literatura
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas','campo_destino'=>'matricula', 'id_servicio_complementario'=>5 ],  [ 'region'=> [[ 3,3,16,3]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas','campo_destino'=>'matricula', 'id_servicio_complementario'=>19],  [ 'region'=> [[ 3,4,16,4]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas','campo_destino'=>'matricula', 'id_servicio_complementario'=>20],  [ 'region'=> [[ 3,5,16,5]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas','campo_destino'=>'matricula', 'id_servicio_complementario'=>21],  [ 'region'=> [[ 3,6,16,6]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas','campo_destino'=>'matricula', 'id_servicio_complementario'=>22],  [ 'region'=> [[ 3,7,16,7]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas','campo_destino'=>'matricula', 'id_servicio_complementario'=>23],  [ 'region'=> [[ 3,8,16,8]] ] ); 
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas', 'id_oferta_educativa'=>  8, 'id_personal'=>1 ],  [ 'region'=> [[11,3,11,8]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas', 'id_oferta_educativa'=>  8, 'id_personal'=>2 ],  [ 'region'=> [[12,3,12,8]] ] );
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas', 'id_oferta_educativa'=> 80, 'id_personal'=>1 ],  [ 'region'=> [[13,3,13,8]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas', 'id_oferta_educativa'=> 80, 'id_personal'=>2 ],  [ 'region'=> [[14,3,14,8]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas', 'id_oferta_educativa'=>  9, 'id_personal'=>1 ],  [ 'region'=> [[15,3,15,8]] ] ); 
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'matricula_atendida_areas', 'id_oferta_educativa'=>  9, 'id_personal'=>2 ],  [ 'region'=> [[16,3,16,8]] ] );




// CUADRO 16) CANTIDAD DE ALUMNOS Y SECCIONES POR TURNO SEGÚN MODALIDAD
		$C=$F->cuadros[16];
	...
	// turnos= M,I,T,V,N,D,A
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','campo_destino'=>'alumnos', 
		                           'id_oferta_educativa'=>  8, 'id_personal'=>1],  [ 'region'=> [[3,10,9,10]] ] );  // alumnos, bach. 3a;os
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','campo_destino'=>'secciones', 
		                           'id_oferta_educativa'=>  8, 'id_personal'=>1],  [ 'region'=> [[3,11,9,11]] ] );  // secciones, bach. 3 a;os
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','campo_destino'=>'alumnos', 
		                           'id_oferta_educativa'=> 80, 'id_personal'=>1],  [ 'region'=> [[3,12,9,12]] ] );  // alumnos, bach. 4 a;os
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','campo_destino'=>'secciones', 
		                           'id_oferta_educativa'=> 80, 'id_personal'=>1],  [ 'region'=> [[3,13,9,13]] ] );  // secciones, bach. 4 a;os
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','campo_destino'=>'alumnos', 
		                           'id_oferta_educativa'=>  9, 'id_personal'=>1],  [ 'region'=> [[3,14,9,14]] ] );  // alumnos, sist. dual
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','campo_destino'=>'secciones', 
		                           'id_oferta_educativa'=>  9, 'id_personal'=>1],  [ 'region'=> [[3,15,9,15]] ] );  // secciones, sist. dual

		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=> 'M' ],  [ 'region'=> [[3,2,3,15]] ] );  // M
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=> 'I' ],  [ 'region'=> [[4,2,4,15]] ] );  // I
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=> 'T' ],  [ 'region'=> [[5,2,5,15]] ] );  // T
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=> 'V' ],  [ 'region'=> [[6,2,6,15]] ] );  // V
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=> 'N' ],  [ 'region'=> [[7,2,7,15]] ] );  // N
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=> 'D' ],  [ 'region'=> [[8,2,8,15]] ] );  // D
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones_matricula_turno','id_turno'=> 'A' ],  [ 'region'=> [[9,2,9,15]] ] );  // A



// CUADRO 17) CANTIDAD DE ALUMNOS POR TIPO DE JORNADA SEGÚN MODALIDAD
		$C=$F->cuadros[17];
	...
	// JORNADA= 1) JOR. SIMPLE/ 2) JOR EXT. 30 / 3) JOR. DOBLE  40 / 4) JOR. AGROT.
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos_por_tipo_jornada','campo_destino'=>'alumnos', 'id_oferta_educativa'=>  8],  [ 'region'=> [[3,10,6,10]] ] );  // B. ADULT 3
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos_por_tipo_jornada','campo_destino'=>'alumnos', 'id_oferta_educativa'=> 80],  [ 'region'=> [[3,11,6,11]] ] );  // B. ADULT.4
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos_por_tipo_jornada','campo_destino'=>'alumnos', 'id_oferta_educativa'=>  9],  [ 'region'=> [[3,12,6,12]] ] );  // SIST.DUAL 


		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos_por_tipo_jornada','id_tipo_jornada'=> '1' ],  [ 'region'=> [[3,2,3,12]] ] );  // j. simp.
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos_por_tipo_jornada','id_tipo_jornada'=> '2' ],  [ 'region'=> [[4,2,4,12]] ] );  // j. ext.
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos_por_tipo_jornada','id_tipo_jornada'=> '4' ],  [ 'region'=> [[5,2,5,12]] ] );  // j. AGROT.
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos_por_tipo_jornada','id_tipo_jornada'=> '3' ],  [ 'region'=> [[6,2,6,12]] ] );  // j. dobl.



    	return ($F);

	} //function F2022_SECUNDARIA
...
// CUADRO 6) CANTIDAD DE DIVISIONES POR AÑO
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones', 'id_oferta_educativa'=>13, 'id_tipo_seccion'=>'A'],  [ 'region'=> [[4,2,4,6]] ] ); // CURSOS DE SUP.
		$C->save_cuadro_migrador (['tabla_destino'=>'secciones', 'id_oferta_educativa'=>14],  [ 'region'=> [[5,2,5,6]] ] ); // CURSOS DE SUP.
        ...
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>5],  [ 'region'=> [[3,6, 5,6]] ] );
