...
class DefinicionMigracionI2018Controller extends Controller
{
    ////

static public function I2018()
    {
   	  //$F=DefinicionMigracionI2018Controller::I2018_INICIAL(15);
      // $F=DefinicionMigracionI2018Controller::I2018_PRIMARIA(16);

     //   $F=DefinicionMigracionI2018Controller::I2018_SECUNDARIA(17);
     //   $F=DefinicionMigracionI2018Controller::I2018_SUPERIOR(18); 
     //  $F=DefinicionMigracionI2018Controller::I2018_EPA(19); 
     //    $F=DefinicionMigracionI2018Controller::I2018_CENS(20);
 	 $F=DefinicionMigracionI2018Controller::I2018_ESPECIAL(21); 
     //    $F=DefinicionMigracionI2018Controller::I2018_ARTISTICA(22); 
     //    $F=DefinicionMigracionI2018Controller::I2018_FP(23);
     //    $F=DefinicionMigracionI2018Controller::I2018_CEC(24);        
     //    $F=DefinicionMigracionI2018Controller::I2018_CEF(25);
        
     // $F=DefinicionMigracionI2018Controller::I2018_CIIE(26);
...
// CUADRO 3) CANTIDAD DE ALUMNOS DE EPA SEGÚN CICLO Y SEXO
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>15 ],  [ 'region'=> [[4,1,4,4]] ] );
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>39 ],  [ 'region'=> [[4,5,4,6]] ] );
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>15,'id_modo_de_dictado'=>2 ],  [ 'region'=> [[4,7,4,8]] ] );
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>1],  [ 'columnas'=> [5,6] ] );
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>4],  [ 'columnas'=> [7,8] ] );

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'campo_destino'=>'mujer'],  [ 'celdas'=> [[4,2],[4,4],[4,6],[4,8]] ] );
...
// CUADRO 4) CANTIDAD DE SECCIONES / GRUPOS DE EPA SEGÚN MODO DE DICTADO Y CICLO.
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_oferta_educativa'=>15], [ 'region'=> [[3,1,3,3]] ] );
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_oferta_educativa'=>39], [ 'celdas'=> [[3,4]] ] );
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_oferta_educativa'=>15], [ 'celdas'=> [[3,5]] ] );
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>999,'id_tipo_seccion'=>'M'],  [ 'columnas'=> [3] ] );
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>1],  [ 'columnas'=> [4] ] );
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>4, 'id_tipo_seccion'=>'S'],  ['columnas'=> [5] ] );
...
// CUADRO 3) CANTIDAD DE ALUMNOS Y HORAS CÁTEDRA EN CURSOS DE FORMACIÓN PROFESIONAL
        ...
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','campo_destino'=>'hs_cat_semanal'],   ['celdas'=> [[3,6]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','campo_destino'=>'finaliza_fecha'] ,  ['celdas'=> [[3,7]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','campo_destino'=>'finaliza_aprobado'],['celdas'=> [[3,8]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','campo_destino'=>'observaciones'],    ['celdas'=> [[3,9]] ] );
