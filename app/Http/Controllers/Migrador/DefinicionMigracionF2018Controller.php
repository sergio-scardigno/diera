...
class DefinicionMigracionF2018Controller extends Controller
{
    ////

static public function F2018()
    {
   	 //$F=DefinicionMigracionF2018Controller::F2018_INICIAL(1);
     //$F=DefinicionMigracionF2018Controller::F2018_PRIMARIA(2);
     //$F=DefinicionMigracionF2018Controller::F2018_SECUNDARIA(3);
     //$F=DefinicionMigracionF2018Controller::F2018_SUPERIOR(4); 
     //$F=DefinicionMigracionF2018Controller::F2018_EPA(5); 
     //$F=DefinicionMigracionF2018Controller::F2018_CENS(6);
     $F=DefinicionMigracionF2018Controller::F2018_ESPECIAL(7); 
     //$F=DefinicionMigracionF2018Controller::F2018_ARTISTICA(8); 
     //$F=DefinicionMigracionF2018Controller::F2018_FP(9);
     //$F=DefinicionMigracionF2018Controller::F2018_CEC(10);        
     //$F=DefinicionMigracionF2018Controller::F2018_CEF(11);
     //$F=DefinicionMigracionF2018Controller::F2018_CIIE(12);
...
static public function F2018_INICIAL ($id_definicion_formulario)
	...
	// CUADRO 8) NOMENCLATURA CATASTRAL

		$C=$F->cuadros[8];
			
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Partido' 			],  [ 'celdas'=> [[2,1]] ] );  // Partido
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Circunscripcion'	],  [ 'celdas'=> [[2,2]] ] );  // Circunscripcion
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Seccion' 			],  [ 'celdas'=> [[2,3]] ] );  // Seccion
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Chacra' 			],  [ 'celdas'=> [[2,4]] ] );  // Chacra
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Quinta'				],  [ 'celdas'=> [[2,5]] ] );  // Quinta
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Fraccion' 			],  [ 'celdas'=> [[2,6]] ] );  // Fraccion
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Manzana' 			],  [ 'celdas'=> [[2,7]] ] );  // Manzana
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_nomencla','campo_destino'=>'Parcela' 			],  [ 'celdas'=> [[2,8]] ] );  // Parcela
	...
	// CUADRO 9) SERVICIOS
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_sit_dominial', 'campo_destino'=>'IdSitNom'],  			[ 'celdas'=> [[1,2]] ] );  // 1 propio; 2 Alquilado; 3 Cedido; 4 Otro; 5 Ns/Nc
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_servicios'   , 'campo_destino'=>'IdInfra_Servicio'], 	[ 'celdas'=> [[2,2]] ] );  // 1 Red pública; 2 Envasado; 3 No tiene; 4 Ns/Nc
		$C->save_cuadro_migrador (['tabla_destino'=>'servicio',	'vista'=>'infra_aulas'       , 'campo_destino'=>'cantidad'], 			[ 'celdas'=> [[3,2]] ] );  // cantidad de aulas    
...
static public function F2018_PRIMARIA ($id_definicion_formulario)
	...
	// CUADRO 12) NOMENCLATURA CATASTRAL
...
static public function F2018_SECUNDARIA ($id_definicion_formulario)
	...
	// cuadro 5) NIVEL SECUNDARIO - CANTIDAD DE ALUMNOS DE EDUCACIÓN SECUNDARIA CICLO SUPERIOR TECNICO Y AGRARIO POR AÑO Y SEXO SEGÚN ORIENTACIÓN. R.302/12..
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_modalidad'=>314,'id_terminalidad_titulo'=>314],  [ 'filas'=> [23] ] ); //Técnico en producción agropecuaria
	...
	// CUADRO 19) NOMENCLATURA CATASTRAL
...
static public function F2018_SUPERIOR ($id_definicion_formulario)
	...
	// CUADRO 6) NOMENCLATURA CATASTRAL
...
static public function F2018_EPA ($id_definicion_formulario)
	...
	// CUADRO 5) NOMENCLATURA CATASTRAL
...
static public function F2018_CENS ($id_definicion_formulario)
	...
	// CUADRO 3) CANTIDAD DE ALUMNOS DE MODALIDAD PRESENCIAL
	...
	// CUADRO 4) CANTIDAD DE ALUMNOS DE MODALIDAD SEMIPRESENCIAL Resol. 737/07
		...
		$C=$F->cuadros[4];
       	$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>16,
										...
										'id_caracteristica_matricula'=>1,
										'id_anio_estudio'=>4, // Modularizado
										'tabla_destino'=>'alumnos',
										'campo_destino'=>'varon',
										'col_combo1'=>1,
										'cp_destino1'=>'id_oferta_educativa',
	...
	// CUADRO 5) CANTIDAD DE SECCIONES SEGÚN MODO DE DICTADO Y AÑO
        ...
        $C->save_cuadro_migrador (	[	'id_oferta_educativa'=>16, 
										...
										'tabla_destino'=>'secciones',
										'campo_destino'=>'cantidad',
                                	],  [ 'region'=> [[2,2,2,4]], 'celdas'=> [[3,5] ]] );

        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>1],  [ 'celdas'=> [[2,2]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>2],  [ 'celdas'=> [[2,3]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>3],  [ 'celdas'=> [[2,4]] ] );
        $C->save_cuadro_migrador ([ 'tabla_destino'=>'secciones','id_anio_estudio'=>4,'id_tipo_seccion'=>'S'],  [ 'celdas'=> [[3,5]] ] );


	// CUADRO 6) CANTIDAD DE ALUMNOS Y COMISIONES DE PLANES FINES
	...
	// CUADRO 7) NOMENCLATURA CATASTRAL
...
static public function F2018_ESPECIAL ($id_definicion_formulario)
	...
	// CUADRO 3) ALUMNOS MATRICULADOS EN EL NIVEL INICIAL (ATDI) 0 A 3 AÑOS
	...
	// CUADRO 4) ALUMNOS MATRICULADOS EN LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)
	...
	// CUADRO 5) ALUMNOS MATRICULADOS, DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO, DOMICILIARIOS Y HOSPITALARIOS
	...
	// CUADRO 6) ALUMNOS MATRICULADOS EN FORMACIÓN LABORAL (EN SEDE)
	...
	// CUADRO 7) ALUMNOS MATRICULADOS EN LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)
	...
	// CUADRO 8) ALUMNOS MATRICULADOS EN FORMACIÓN LABORAL (EN INTEGRACIÓN)
	...
	// CUADRO 9) ALUMNOS MATRICULADOS EN ORIENTACION MANUAL Y PRE-TALLER
	...
	// CUADRO 11) EGRESADOS QUE FINALIZAN LA ETAPA EN EL NIVEL INICIAL (ATDI) 0 A 3 AÑOS.
		$C=$F->cuadros[11];
		$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>17,
										'id_modalidad'=>601,
										'id_terminalidad_titulo'=>0,
										'id_modo_de_dictado'=>1,
										'id_caracteristica_matricula'=>3, // egresados
										'id_anio_estudio'=>1,
										'tabla_destino'=>'alumnos',
										'campo_destino'=>'varon',
										//    'col_combo1'=>1,
	...
	// CUADRO 12) EGRESADOS DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)
		$C=$F->cuadros[12];
		$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>0,
										'id_modalidad'=>0,
										'id_terminalidad_titulo'=>0,
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>18,'id_modalidad'=>602 ],  [ 'region'=> [[3,2,9,3]] ] );  // N. inicial
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>19,'id_modalidad'=>603 ],  [ 'region'=> [[3,4,9,5]] ] );  //n. primario
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>65,'id_modalidad'=>617 ],  [ 'region'=> [[3,6,9,7]] ] );  //n.secundario

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600026],  [ 'region'=> [[ 3,2, 3,7]] ] ); // SORDOS E HIPOACUSICOS  
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600027],  [ 'region'=> [[ 4,2, 4,7]] ] ); // CIEGOS Y DISMINUIDOS VISUALES  
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600028],  [ 'region'=> [[ 5,2, 5,7]] ] ); // DISCAPACITADOS MOTORES Y NEUROLOCOMOTORES 
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600029],  [ 'region'=> [[ 6,2, 6,7]] ] ); //	TRASTORNOS EMOCIONALES SEVEROS  
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600025],  [ 'region'=> [[ 7,2, 7,7]] ] ); // RETARDO MENTAL  
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600030],  [ 'region'=> [[ 8,2, 8,7]] ] ); // TRASTORNOS EN EL DESARROLLO DEL LENGUAJE Y LA COMUNICACION 
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600018],  [ 'region'=> [[ 9,2, 9,7]] ] ); // MULTIIMPEDIDOS  

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'campo_destino'=>'mujer'],  [ 'region'=> [[3,3,9,3],[3,5,9,5],[3,7,9,7]] ] );



	// CUADRO 13) EGRESADOS, DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO, DOMICILIARIOS Y HOSPITALARIOS

		$C=$F->cuadros[13];
		$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>0,
										'id_modalidad'=>0,
										'id_terminalidad_titulo'=>0,
										'id_modo_de_dictado'=>0,
										'id_caracteristica_matricula'=>3, //egresados
										'id_anio_estudio'=>999,
										'tabla_destino'=>'alumnos',
										'campo_destino'=>'varon',
		...
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>21,'id_modalidad'=>610 ],  [ 'region'=> [[3,3,4,4]] ] );  // DOMIC. N. inicial
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>22,'id_modalidad'=>611 ],  [ 'region'=> [[3,5,4,6]] ] );  // DOMIC. n. primario
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>68,'id_modalidad'=>614 ],  [ 'region'=> [[3,7,4,8]] ] );  // DOMIC. n.secundario

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>23,'id_modalidad'=>612 ],  [ 'region'=> [[5,3,6,4]] ] );  // HOSP. N. inicial
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>24,'id_modalidad'=>613 ],  [ 'region'=> [[5,5,6,6]] ] );  // HOSP. n. primario
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>69,'id_modalidad'=>615 ],  [ 'region'=> [[5,7,6,8]] ] );  // HOSP. n.secundario


		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600031,'id_modo_de_dictado'=>4], [ 'region'=> [[3,3,3,8]] ] ); // DOMICILIARIO PERMANENTE
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600032,'id_modo_de_dictado'=>4], [ 'region'=> [[4,3,4,8]] ] ); // DOMICILIARIO TRANSITORIO  
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600031,'id_modo_de_dictado'=>3], [ 'region'=> [[5,3,5,8]] ] ); // HOSPITALARO PERMANENTE 
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600032,'id_modo_de_dictado'=>3], [ 'region'=> [[6,3,6,8]] ] ); // HOSPITALARIO TRANSITORIO  

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'campo_destino'=>'mujer'],  [ 'region'=> [[3,4,6,4],[3,6,6,6],[3,8,6,8]] ] );


	// CUADRO 14) EGRESADOS DE FORMACIÓN LABORAL (EN SEDE)
	...
	// CUADRO 15) EGRESADOS DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)

		$C=$F->cuadros[15];
		$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>0,
										'id_modalidad'=>0,
										'id_terminalidad_titulo'=>0,
										'id_modo_de_dictado'=>5,  // integración
										'id_caracteristica_matricula'=>3, // egresados
										'id_anio_estudio'=>999,
										'tabla_destino'=>'alumnos',
										'campo_destino'=>'varon',
	...
	// CUADRO 16) EGRESADOS DE FORMACIÓN LABORAL (EN INTEGRACIÓN)
	...
	// CUADRO 17) RESULTADO DE LA ENSEÑANZA DE NIVEL INICIAL (ATDI) 0 A 3 AÑOS.
		
		$C=$F->cuadros[17];
		$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>17, // (ATDI)
										'id_modalidad'=>601,
										'id_terminalidad_titulo'=>600000,
										'id_modo_de_dictado'=>1,
										'id_caracteristica_matricula'=>21, // 21 continua
										'id_anio_estudio'=>1,
										'tabla_destino'=>'alumnos',
										'campo_destino'=>'varon',										
										//    'col_combo1'=>1,
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>22,],  ['region'=> [[4,2,4,3]] ] ); // 22 finaliza
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','campo_destino'=>'mujer'],  ['region'=> [[3,3,4,3]] ] );




	// CUADRO 18) RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)

		$C=$F->cuadros[18];
		$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>0,
										'id_modalidad'=>0,
										'id_terminalidad_titulo'=>600000,
										'id_modo_de_dictado'=>1, //1 (EN SEDE)
										'id_caracteristica_matricula'=>5, // 5 Continuan en el Ciclo.
										'id_anio_estudio'=>1,
										'tabla_destino'=>'alumnos',
										'campo_destino'=>'varon',
									],  [ 'region'=> [[4,2,5,11]] ] );

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>18,'id_modalidad'=>602 ],  [ 'region'=> [[4,2,5,3]] ] );  // N. inicial
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>19,'id_modalidad'=>603 ],  [ 'region'=> [[4,4,5,7]] ] );  //n. primario
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>65,'id_modalidad'=>617 ],  [ 'region'=> [[4,8,5,11]] ] ); //n.secundario

		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>6 ],  ['region'=> [[5,2,5,11]] ] ); // 6 Promueve al ciclo/nivel siguiente.

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>1],  [ 'region'=> [[4,4,5,5],[4, 8,5, 9]] ] );
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>2],  [ 'region'=> [[4,6,5,7],[4,10,5,11]] ] );

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'campo_destino'=>'mujer'],  [ 'region'=> [[4,3,5,3],[4,5,5,5],[4,7,5,7],[4,9,5,9],[4,11,5,11]] ] );


	// CUADRO 19) RESULTADO DE LA ENSEÑANZA, DE DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO, DOMICILIARIOS Y HOSPITALARIOS
		...
		$C->save_cuadro_migrador (	[	'id_oferta_educativa'=>0,
										...
										'id_caracteristica_matricula'=>0, // codigo de resultado
										'id_anio_estudio'=>1,
										'tabla_destino'=>'alumnos',
										'campo_destino'=>'varon',
									],  [ 'region'=> [[4,4,15,13]] ] );

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>21,'id_modalidad'=>610 ],  [ 'region'=> [[4, 4, 9, 5]] ] );  // DOMIC. N. inicial
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>22,'id_modalidad'=>611 ],  [ 'region'=> [[4, 6, 9, 9]] ] );  // DOMIC. n. primario
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>68,'id_modalidad'=>614 ],  [ 'region'=> [[4,10, 9,13]] ] );  // DOMIC. n.secundario

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>23,'id_modalidad'=>612 ],  [ 'region'=> [[10, 4,15,5]] ] );  // HOSP. N. inicial
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>24,'id_modalidad'=>613 ],  [ 'region'=> [[10 ,6,15,9]] ] );  // HOSP. n. primario
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_oferta_educativa'=>69,'id_modalidad'=>615 ],  [ 'region'=> [[10,10,15,13]] ] ); // HOSP. n.secundario


		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600031,'id_modo_de_dictado'=>4],  [ 'region'=> [[ 4, 4, 6,13]] ] ); // DOMICILIARIO PERMANENTE
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600032,'id_modo_de_dictado'=>4],  [ 'region'=> [[ 7, 4, 9,13]] ] ); // DOMICILIARIO TRANSITORIO  
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600031,'id_modo_de_dictado'=>3],  [ 'region'=> [[10, 4,12,13]] ] ); // HOSPITALARO PERMANENTE 
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos','id_terminalidad_titulo'=>600032,'id_modo_de_dictado'=>3],  [ 'region'=> [[13, 4,15,13]] ] ); // HOSPITALARIO TRANSITORIO  

		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>5 ], ['region'=> [[4,4,4,13],[7,4,7,13],[10,4,10,13],[13,4,13,13]] ] ); // 5 Continuan en el Ciclo.
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>6 ], ['region'=> [[5,4,5,13],[8,4,8,13],[11,4,11,13],[14,4,14,13]] ] ); // 6 Promueve al ciclo/nivel siguiente.
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>7 ], ['region'=> [[6,4,6,13],[9,4,9,13],[12,4,12,13],[15,4,15,13]] ] ); // 7 Desaprobados.


		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>1],  [ 'region'=> [[4,6,15,7],[4,10,15,11]] ] );
		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'id_anio_estudio'=>2],  [ 'region'=> [[4,8,15,9],[4,12,15,13]] ] );

		$C->save_cuadro_migrador (['tabla_destino'=>'alumnos', 'campo_destino'=>'mujer'], [ 'region'=> [[4,5,15,5],[4,7,15,7],[4,9,15,9],[4,11,15,11],[4,13,15,13]] ] );



	// CUADRO 20) RESULTADO DE LA ENSEÑANZA DE FORMACIÓN LABORAL (EN SEDE)
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>23], [ 'region'=> [[3,2,3,3]] ] ); // (23)  Aprobado
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>7 ], [ 'region'=> [[4,2,4,3]] ] ); // (7)  Desaprobados
	...
	// CUADRO 21) RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)
	...
	// CUADRO 22) RESULTADO DE LA ENSEÑANZA DE FORMACIÓN LABORAL (EN INTEGRACIÓN)
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>24], [ 'region'=> [[3,2,3,3]] ] ); // (24) Continua
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>6 ], [ 'region'=> [[4,2,4,3]] ] ); // (6)  Promueve al ciclo/nivel siguiente.
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_caracteristica_matricula'=>7 ], [ 'region'=> [[5,2,5,3]] ] ); // (7)  Desaprobados
	...
	// CUADRO 23) NOMENCLATURA CATASTRAL
...
static public function F2018_ARTISTICA ($id_definicion_formulario)
	...
	// CUADRO 10) NOMENCLATURA CATASTRAL
...
static public function F2018_FP ($id_definicion_formulario)
	...
	// CUADRO 4) NOMENCLATURA CATASTRAL
...
static public function F2018_CEF ($id_definicion_formulario)
	...
	// CUADRO 3) ALUMNOS POR TIPO DE ATENCIÓN Y SEXO SEGÚN OFERTA EDUCATIVA
		...
		$C->save_cuadro_migrador ([ 'tabla_destino'=>'alumnos','id_anio_estudio'=>2],  [ 'region'=> [[3,4,3,5]] ] ); // Atencion de oro servicio
