...
class ArmarI2021Controller extends Controller
{


static public function I2021()
    {

        //dd('Lanzar creación de formularios INICIAL 2021');

        
        $F=ArmarI2021Controller::I2021_INICIAL(78);
        //$F=ArmarI2021Controller::I2021_PRIMARIA(79);
        //$F=ArmarI2021Controller::I2021_SECUNDARIA(80);
        //$F=ArmarI2021Controller::I2021_SUPERIOR(81);
        //$F=ArmarI2021Controller::I2021_EPA(82);
        //$F=ArmarI2021Controller::I2021_CENS(83);
        //$F=ArmarI2021Controller::I2021_ESPECIAL(84);
        //$F=ArmarI2021Controller::I2021_ARTISTICA(85);
        //$F=ArmarI2021Controller::I2021_FP(86);
        //$F=ArmarI2021Controller::I2021_CEC(87);
        //$F=ArmarI2021Controller::I2021_CEF(88);
        //$F=ArmarI2021Controller::I2021_CIIE(89);
...
// return $F2;
    ...
    static public function I2021_INICIAL($id_definicion_formulario)
    {
...
//definir un nuevo formulario
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN INICIAL';
      $F->nombre_corto='ED. INICIAL';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de Ed. inicial';
      $F->id_periodo='95';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2021 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2021 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2021 - inicial cuadro 4') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2021 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2021 - inicial cuadro 5') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2021 - inicial cuadro 6') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2021 - inicial cuadro 6') ;
...
static public function I2021_PRIMARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN PRIMARIA';
      $F->nombre_corto='ED. PRIMARIA';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de Ed. Primaria';
      $F->id_periodo='95';
      $F->color='f_celeste';
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2021 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2021 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2021 - inicial cuadro 5') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - primaria cuadro 6') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - primaria cuadro 7') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2021 - primaria cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2021 - primaria cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - primaria cuadro 9') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2021 - primaria 10 j. mat.') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2021 - primaria 10 j. inf.') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - primaria 10 secu') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2021 - primaria cuadro 11') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2021 - primaria cuadro 11') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - primaria cuadro 11') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'I2021 - primaria cuadro 6') ;
...
static public function I2021_SECUNDARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN SECUNDARIA / POLIMODAL / MEDIA';
      $F->nombre_corto='ED. SECUNDARIA';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de Ed. Secundaria';
      $F->id_periodo='95';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - secundaria cuadro 2') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - secundaria cuadro 3') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - secundaria cuadro 5') ; //110=Común - Secundaria Completa req. 6 años 
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - secundaria cuadro 6') ; //110=Común - Secundaria Completa req. 6 años
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2021 - secundaria cuadro 5') ;  //112=Común - Polimodal
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2021 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - secundaria cuadro 17') ;
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2021 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - secundaria cuadro 18') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2021 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2021 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - secundaria cuadro 19') ;
...
static public function I2021_SUPERIOR($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN SUPERIOR';
      $F->nombre_corto='ED. SUPERIOR';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de Ed. Superior';
      $F->id_periodo='95';
      $F->color='f_verde';
...
// //       //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'I2021 - SUPERIOR cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 117, [117],'I2021 - SUPERIOR cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1115, [115,117],'I2021 - SUPERIOR cuadro 5') ;
...
///////////////////////////////
     ...
     */
    static public function I2021_EPA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN PRIMARIA DE ADULTOS';
      $F->nombre_corto='ED. PRIMARIA DE ADULTOS';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de EPA';
      $F->id_periodo='95';
      $F->color='f_violeta';
...
static public function I2021_CENS($id_definicion_formulario)
{
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN DE ADULTOS (CENS)';
      $F->nombre_corto='ED. DE ADULTOS (CENS)';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de CENS.';
      $F->id_periodo='95';
      $F->color='f_violeta';
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - CENS cuadro 6') ;
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2021 - CENS cuadro 5') ;
...
static public function I2021_ESPECIAL($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN ESPECIAL';
      $F->nombre_corto='ED. ESPECIAL';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de Especial';
      $F->id_periodo='95';
      $F->color='f_rosa';
...
static public function I2021_ARTISTICA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - EDUCACIÓN ARTÍSTICA';
      $F->nombre_corto='ED. ARTÍSTICA';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de Artistica';
      $F->id_periodo='95';
      $F->color='f_marron';
...
static public function I2021_FP($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - FORMACION PROFESIONAL';
      $F->nombre_corto='FORMACION PROFESIONAL';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de Formación Profesional';
      $F->id_periodo='95';
      $F->color='f_naranja';
...
static public function I2021_CEC($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - CENTRO EDUCATIVO COMPLEMENTARIO';
      $F->nombre_corto='CENTRO ED. COMPLEMENTARIO';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de C.E.C.';
      $F->id_periodo='95';
      $F->color='f_amarillo';
...
// //       //
     ...
     //fila 2
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 116, [116],'I2021 - c.e.c. cuadro 4') ;
...
static public function I2021_CEF($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - CENTRO EDUCACIÓN FÍSICA';
      $F->nombre_corto='CENTRO ED. FÍSICA';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de C.E.F.';
      $F->id_periodo='95';
      $F->color='f_amarillo';
...
static public function I2021_CIIE($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2021 - CIIE';
      $F->nombre_corto='CIIE';
      $F->descripcion='Planilla Relevamiento Inicial 2021 de CIIE';
      $F->id_periodo='95';
      $F->color='f_verde';
