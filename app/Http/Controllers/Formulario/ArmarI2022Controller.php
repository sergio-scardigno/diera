...
class ArmarI2022Controller extends Controller
{


static public function I2022()
    {

        //dd('Lanzar creación de formularios INICIAL 2022');

      
        $F=ArmarI2022Controller::I2022_INICIAL(102);
        //$F=ArmarI2022Controller::I2022_PRIMARIA(103);
        //$F=ArmarI2022Controller::I2022_SECUNDARIA(104);
        //$F=ArmarI2022Controller::I2022_SUPERIOR(105);
        //$F=ArmarI2022Controller::I2022_EPA(106);
        //$F=ArmarI2022Controller::I2022_CENS(107);
        //$F=ArmarI2022Controller::I2022_ESPECIAL(108);
        //$F=ArmarI2022Controller::I2022_ARTISTICA(109);
        //$F=ArmarI2022Controller::I2022_FP(110);
        //$F=ArmarI2022Controller::I2022_CEC(111);
        //$F=ArmarI2022Controller::I2022_CEF(112);
        //$F=ArmarI2022Controller::I2022_CIIE(113);
...
static public function I2022_INICIAL($id_definicion_formulario)
    {
...
//definir un nuevo formulario
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN INICIAL';
      $F->nombre_corto='ED. INICIAL';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de Ed. inicial';
      $F->id_periodo='100';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2022 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2022 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2022 - inicial cuadro 4') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2022 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2022 - inicial cuadro 5') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2022 - inicial cuadro 6') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2022 - inicial cuadro 6') ;
...
static public function I2022_PRIMARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN PRIMARIA';
      $F->nombre_corto='ED. PRIMARIA';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de Ed. Primaria';
      $F->id_periodo='100';
      $F->color='f_celeste';
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2022 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2022 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2022 - inicial cuadro 5') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - primaria cuadro 6') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - primaria cuadro 7') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2022 - primaria cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2022 - primaria cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - primaria cuadro 9') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2022 - primaria 10 j. mat.') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2022 - primaria 10 j. inf.') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - primaria 10 secu') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2022 - primaria cuadro 11') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2022 - primaria cuadro 11') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - primaria cuadro 11') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'I2022 - primaria cuadro 6') ;
...
static public function I2022_SECUNDARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN SECUNDARIA / POLIMODAL / MEDIA';
      $F->nombre_corto='ED. SECUNDARIA';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de Ed. Secundaria';
      $F->id_periodo='100';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - secundaria cuadro 2') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - secundaria cuadro 3') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - secundaria cuadro 5') ; //110=Común - Secundaria Completa req. 6 años 
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - secundaria cuadro 6') ; //110=Común - Secundaria Completa req. 6 años
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2022 - secundaria cuadro 5') ;  //112=Común - Polimodal
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2022 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - secundaria cuadro 17') ;
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2022 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - secundaria cuadro 18') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2022 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2022 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - secundaria cuadro 19') ;
...
static public function I2022_SUPERIOR($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN SUPERIOR';
      $F->nombre_corto='ED. SUPERIOR';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de Ed. Superior';
      $F->id_periodo='100';
      $F->color='f_verde';
...
//          //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'I2022 - SUPERIOR cuadro 6') ;
      $CN->mapacuadro_store_c_mapa ( 117, [117],'I2022 - SUPERIOR cuadro 6') ;
      $CN->mapacuadro_store_c_mapa (1115, [115,117],'I2022 - SUPERIOR cuadro 6') ;
...
///////////////////////////////
     ...
     */
    static public function I2022_EPA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN PRIMARIA DE ADULTOS';
      $F->nombre_corto='ED. PRIMARIA DE ADULTOS';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de EPA';
      $F->id_periodo='100';
      $F->color='f_violeta';
...
static public function I2022_CENS($id_definicion_formulario)
{
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN DE ADULTOS (CENS)';
      $F->nombre_corto='ED. DE ADULTOS (CENS)';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de CENS.';
      $F->id_periodo='100';
      $F->color='f_violeta';
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - CENS cuadro 6') ;
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2022 - CENS cuadro 5') ;
...
static public function I2022_ESPECIAL($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN ESPECIAL';
      $F->nombre_corto='ED. ESPECIAL';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de Especial';
      $F->id_periodo='100';
      $F->color='f_rosa';
...
static public function I2022_ARTISTICA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - EDUCACIÓN ARTÍSTICA';
      $F->nombre_corto='ED. ARTÍSTICA';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de Artistica';
      $F->id_periodo='100';
      $F->color='f_marron';
...
static public function I2022_FP($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - FORMACION PROFESIONAL';
      $F->nombre_corto='FORMACION PROFESIONAL';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de Formación Profesional';
      $F->id_periodo='100';
      $F->color='f_naranja';
...
static public function I2022_CEC($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - CENTRO EDUCATIVO COMPLEMENTARIO';
      $F->nombre_corto='CENTRO ED. COMPLEMENTARIO';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de C.E.C.';
      $F->id_periodo='100';
      $F->color='f_amarillo';
...
// //       //
     ...
     //fila 2
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 116, [116],'I2022 - c.e.c. cuadro 4') ;
...
static public function I2022_CEF($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - CENTRO EDUCACIÓN FÍSICA';
      $F->nombre_corto='CENTRO ED. FÍSICA';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de C.E.F.';
      $F->id_periodo='100';
      $F->color='f_amarillo';
...
static public function I2022_CIIE($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2022 - CIIE';
      $F->nombre_corto='CIIE';
      $F->descripcion='Planilla Relevamiento Inicial 2022 de CIIE';
      $F->id_periodo='100';
      $F->color='f_verde';
