...
class ArmarF2023Controller extends Controller
{


static public function F2023()
    {

        //dd('Lanzar creación de formularios FINAL 2023');

      
        //$F=ArmarF2023Controller::F2023_INICIAL(138);
        $F=ArmarF2023Controller::F2023_PRIMARIA(139); 
        //$F=ArmarF2023Controller::F2023_SECUNDARIA(140);
        //$F=ArmarF2023Controller::F2023_SUPERIOR(141);
        //$F=ArmarF2023Controller::F2023_EPA(142);
        //$F=ArmarF2023Controller::F2023_CENS(143);
        //$F=ArmarF2023Controller::F2023_ESPECIAL(144);
        //$F=ArmarF2023Controller::F2023_ARTISTICA(145);
        //$F=ArmarF2023Controller::F2023_FP(146);
        //$F=ArmarF2023Controller::F2023_CEC(147);
        //$F=ArmarF2023Controller::F2023_CEF(148);
        //$F=ArmarF2023Controller::F2023_CIIE(149);
...
static public function F2023_INICIAL($id_definicion_formulario)
    {
...
//definir un nuevo formulario
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN INICIAL';
      $F->nombre_corto='ED. INICIAL';
      $F->descripcion='Planilla Relevamiento Final 2023 de Ed. inicial';
      $F->id_periodo='105';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2023 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2023 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'F2023 - inicial cuadro 4') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2023 - inicial cuadro 6') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2023 - inicial cuadro 6') ;
...
//
        ...
        $CN->mapacuadro_store_c_mapa ( 100, [100],'F2023 - inicial cuadro 8') ;
        $CN->mapacuadro_store_c_mapa ( 101, [101],'F2023 - inicial cuadro 8') ;
...
static public function F2023_PRIMARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN PRIMARIA';
      $F->nombre_corto='ED. PRIMARIA';
      $F->descripcion='Planilla Relevamiento FINAL 2023 de Ed. Primaria';
      $F->id_periodo='105';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'PRIMARIA cuadro 2') ;
    ...
    $CN->consistencia_save( 
            [
              ...
              'c_categoria_consistencia' =>  3, // Consistencia de Error
              'c_estado' =>  1, // Consistencia activa
              'cmp1' => ['cua' => [3,8,9,10] ] , // 11 ,agregar cuadro 11 en momento inicial
              'cmp2' => [] ,
              'cmp3' => '',
              'msg1' => '',
              'msg2' => '',
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'PRIMARIA cuadro 3') ;
  ...
  //    $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>1122] , ['region'=> [ [4,12,11,14]] ]);
    ...
    $CN->consistencia_save( 
            [
              ...
              'msg2' => '',
              'msg3' => '',    
              'descripcion' => 'primaria-cuadro 4, control de cuadros dependientes'
            ] ); 
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2023 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2023 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'F2023 - inicial cuadro 5') ;
    ...
    $CN->consistencia_save(
      ...
      $CN->consistencia_save( 
            [
              ...
              'msg2' => '',
              'msg3' => '',    
              'descripcion' => 'primaria-cuadro 5, control de cuadros dependientes'
            ] );  
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - primaria cuadro 6') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - primaria cuadro 7') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 102, [102],'F2023 - primaria 8 PP') ;
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2023 - primaria 8 j. mat.') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2023 - primaria 8 j. inf.') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - primaria 8 secu') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 102, [102],'F2023 - primaria cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2023 - primaria cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2023 - primaria cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - primaria cuadro 9') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'F2023 - primaria cuadro 10') ;
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2023 - primaria cuadro 10') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2023 - primaria cuadro 10') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - primaria cuadro 10') ;
...
/*
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'F2023 - primaria cuadro 6') ;
...
static public function F2023_SECUNDARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN SECUNDARIA / POLIMODAL / MEDIA';
      $F->nombre_corto='ED. SECUNDARIA';
      $F->descripcion='Planilla Relevamiento Final 2023 de Ed. Secundaria';
      $F->id_periodo='105';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 2') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 3') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 5') ; //110=Común - Secundaria Completa req. 6 años 
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 6') ; //110=Común - Secundaria Completa req. 6 años
...
//       // Omitido a partir rel F2023 a pedido de silvina se decidio no relevar mas matricula por modalidad
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 16') ;
      //$CN->mapacuadro_store_c_mapa ( 112, [112],'F2023 - secundaria cuadro 16') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - secundaria cuadro 16') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - secundaria cuadro 16') ;
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 17') ;
     // $CN->mapacuadro_store_c_mapa ( 112, [112],'F2023 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - secundaria cuadro 17') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 18') ;
//      $CN->mapacuadro_store_c_mapa ( 112, [112],'F2023 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - secundaria cuadro 18') ;
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2023 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - secundaria cuadro 19') ;
...
static public function F2023_SUPERIOR($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN SUPERIOR';
      $F->nombre_corto='ED. SUPERIOR';
      $F->descripcion='Planilla Relevamiento Final 2023 de Ed. Superior';
      $F->id_periodo='105';
      $F->color='f_verde';
...
//          //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'F2023 - SUPERIOR cuadro 6') ; // carreras
      $CN->mapacuadro_store_c_mapa ( 117, [117],'F2023 - SUPERIOR cuadro 6') ; // cursos
      $CN->mapacuadro_store_c_mapa (1115, [115,117],'F2023 - SUPERIOR cuadro 6') ; //carreras y cursos
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'F2023 - SUPERIOR cuadro 7') ; // carreras
      $CN->mapacuadro_store_c_mapa ( 117, [117],'F2023 - SUPERIOR cuadro 7') ; // cursos
      //$CN->mapacuadro_store_c_mapa (1115, [115,117],'F2023 - SUPERIOR cuadro 6') ; //carreras y cursos
...
///////////////////////////////
     ...
     */
    static public function F2023_EPA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN PRIMARIA DE ADULTOS';
      $F->nombre_corto='ED. PRIMARIA DE ADULTOS';
      $F->descripcion='Planilla Relevamiento Final 2023 de EPA';
      $F->id_periodo='105';
      $F->color='f_violeta';
...
static public function F2023_CENS($id_definicion_formulario)
{
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN DE ADULTOS (CENS)';
      $F->nombre_corto='ED. DE ADULTOS (CENS)';
      $F->descripcion='Planilla Relevamiento Final 2023 de CENS.';
      $F->id_periodo='105';
      $F->color='f_violeta';
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - CENS cuadro 6') ;
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2023 - CENS cuadro 5') ;
...
static public function F2023_ESPECIAL($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN ESPECIAL';
      $F->nombre_corto='ED. ESPECIAL';
      $F->descripcion='Planilla Relevamiento Final 2023 de Especial';
      $F->id_periodo='105';
      $F->color='f_rosa';
...
static public function F2023_ARTISTICA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - EDUCACIÓN ARTÍSTICA';
      $F->nombre_corto='ED. ARTÍSTICA';
      $F->descripcion='Planilla Relevamiento Final 2023 de Artistica';
      $F->id_periodo='105';
      $F->color='f_marron';
...
static public function F2023_FP($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - FORMACION PROFESIONAL';
      $F->nombre_corto='FORMACION PROFESIONAL';
      $F->descripcion='Planilla Relevamiento Final 2023 de Formación Profesional';
      $F->id_periodo='105';
      $F->color='f_naranja';
...
static public function F2023_CEC($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - CENTRO EDUCATIVO COMPLEMENTARIO';
      $F->nombre_corto='CENTRO ED. COMPLEMENTARIO';
      $F->descripcion='Planilla Relevamiento Final 2023 de C.E.C.';
      $F->id_periodo='105';
      $F->color='f_amarillo';
...
//
     ...
     //fila 2
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 116, [116],'F2023 - c.e.c. cuadro 4') ;
...
static public function F2023_CEF($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - CENTRO EDUCACIÓN FÍSICA';
      $F->nombre_corto='CENTRO ED. FÍSICA';
      $F->descripcion='Planilla Relevamiento Final 2023 de C.E.F.';
      $F->id_periodo='105';
      $F->color='f_amarillo';
...
static public function F2023_CIIE($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2023 - CIIE';
      $F->nombre_corto='CIIE';
      $F->descripcion='Planilla Relevamiento Final 2023 de CIIE';
      $F->id_periodo='105';
      $F->color='f_verde';
