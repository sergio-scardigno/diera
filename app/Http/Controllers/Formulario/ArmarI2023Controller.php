...
class ArmarI2023Controller extends Controller
{
...
static public function I2023()
    {
        ...
        //dd('Lanzar creación de formularios INICIAL 2023');

      
        //$F=ArmarI2023Controller::I2023_INICIAL(126);
        //$F=ArmarI2023Controller::I2023_PRIMARIA(127);
        //$F=ArmarI2023Controller::I2023_SECUNDARIA(128);
        //$F=ArmarI2023Controller::I2023_SUPERIOR(129);
        //$F=ArmarI2023Controller::I2023_EPA(130);
...
//definir un nuevo formulario
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN INICIAL';
      $F->nombre_corto='ED. INICIAL';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de Ed. inicial';
      $F->id_periodo='103';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2023 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2023 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2023 - inicial cuadro 4') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2023 - inicial cuadro 6') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2023 - inicial cuadro 6') ;
...
//
        ...
        $CN->mapacuadro_store_c_mapa ( 100, [100],'I2023 - inicial cuadro 8') ;
        $CN->mapacuadro_store_c_mapa ( 101, [101],'I2023 - inicial cuadro 8') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN PRIMARIA';
      $F->nombre_corto='ED. PRIMARIA';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de Ed. Primaria';
      $F->id_periodo='103';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2023 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2023 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2023 - inicial cuadro 5') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - primaria cuadro 6') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - primaria cuadro 7') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2023 - primaria 10 j. mat.') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2023 - primaria 10 j. inf.') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - primaria 10 secu') ;
...
//
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number',             ] , ['region'=> [ [2,2,8,2]] ]);
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2023 - primaria cuadro 11') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2023 - primaria cuadro 11') ;
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - primaria cuadro 11') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'I2023 - primaria cuadro 6') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN SECUNDARIA / POLIMODAL / MEDIA';
      $F->nombre_corto='ED. SECUNDARIA';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de Ed. Secundaria';
      $F->id_periodo='103';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 2') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 3') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 5') ; //110=Común - Secundaria Completa req. 6 años 
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 6') ; //110=Común - Secundaria Completa req. 6 años
...
//       // Omitido a partir rel I2023 a pedido de silvina se decidio no relevar mas matricula por modalidad
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 16') ;
      //$CN->mapacuadro_store_c_mapa ( 112, [112],'I2023 - secundaria cuadro 16') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - secundaria cuadro 16') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - secundaria cuadro 16') ;
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 17') ;
     // $CN->mapacuadro_store_c_mapa ( 112, [112],'I2023 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - secundaria cuadro 17') ;
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 18') ;
//      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2023 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - secundaria cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - secundaria cuadro 18') ;
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2023 - secundaria cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - secundaria cuadro 19') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN SUPERIOR';
      $F->nombre_corto='ED. SUPERIOR';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de Ed. Superior';
      $F->id_periodo='103';
      $F->color='f_verde';
...
//          //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'I2023 - SUPERIOR cuadro 6') ; // carreras
      $CN->mapacuadro_store_c_mapa ( 117, [117],'I2023 - SUPERIOR cuadro 6') ; // cursos
      $CN->mapacuadro_store_c_mapa (1115, [115,117],'I2023 - SUPERIOR cuadro 6') ; //carreras y cursos
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'I2023 - SUPERIOR cuadro 7') ; // carreras
      $CN->mapacuadro_store_c_mapa ( 117, [117],'I2023 - SUPERIOR cuadro 7') ; // cursos
      //$CN->mapacuadro_store_c_mapa (1115, [115,117],'I2023 - SUPERIOR cuadro 6') ; //carreras y cursos
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN PRIMARIA DE ADULTOS';
      $F->nombre_corto='ED. PRIMARIA DE ADULTOS';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de EPA';
      $F->id_periodo='103';
      $F->color='f_violeta';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN DE ADULTOS (CENS)';
      $F->nombre_corto='ED. DE ADULTOS (CENS)';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de CENS.';
      $F->id_periodo='103';
      $F->color='f_violeta';
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - CENS cuadro 6') ;
...
// //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2023 - CENS cuadro 5') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN ESPECIAL';
      $F->nombre_corto='ED. ESPECIAL';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de Especial';
      $F->id_periodo='103';
      $F->color='f_rosa';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - EDUCACIÓN ARTÍSTICA';
      $F->nombre_corto='ED. ARTÍSTICA';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de Artistica';
      $F->id_periodo='103';
      $F->color='f_marron';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - FORMACION PROFESIONAL';
      $F->nombre_corto='FORMACION PROFESIONAL';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de Formación Profesional';
      $F->id_periodo='103';
      $F->color='f_naranja';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - CENTRO EDUCATIVO COMPLEMENTARIO';
      $F->nombre_corto='CENTRO ED. COMPLEMENTARIO';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de C.E.C.';
      $F->id_periodo='103';
      $F->color='f_amarillo';
...
//
     ...
     //fila 2
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 116, [116],'I2023 - c.e.c. cuadro 4') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - CENTRO EDUCACIÓN FÍSICA';
      $F->nombre_corto='CENTRO ED. FÍSICA';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de C.E.F.';
      $F->id_periodo='103';
      $F->color='f_amarillo';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2023 - CIIE';
      $F->nombre_corto='CIIE';
      $F->descripcion='Planilla Relevamiento Inicial 2023 de CIIE';
      $F->id_periodo='103';
      $F->color='f_verde';
