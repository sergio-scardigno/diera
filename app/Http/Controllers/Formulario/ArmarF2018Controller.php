...
class ArmarF2018Controller extends Controller
{


static public function F2018()
    {

        //dd('Lanzar creación de formularios Final 2008');

        
        // $F=ArmarF2018Controller::F2018_INICIAL(1);
        // $F=ArmarF2018Controller::F2018_PRIMARIA(2);
        // $F=ArmarF2018Controller::F2018_SECUNDARIA(3);
        // $F=ArmarF2018Controller::F2018_SUPERIOR(4);
        // $F=ArmarF2018Controller::F2018_EPA(5);
         $F=ArmarF2018Controller::F2018_CENS(6);
        //$F=ArmarF2018Controller::F2018_ESPECIAL(7);
        // $F=ArmarF2018Controller::F2018_ARTISTICA(8);
        // $F=ArmarF2018Controller::F2018_FP(9);
        // $F=ArmarF2018Controller::F2018_CEC(10);
        // $F=ArmarF2018Controller::F2018_CEF(11);
        // $F=ArmarF2018Controller::F2018_CIIE(12);
        
        //$F=ArmarF2018Controller::modif_Secundaria ();
...
// return $F2;
    ...
    static public function modif_Secundaria ()
    {

// sript para modificar el formulario que ya está en carga, con datos ingresados!!    
...
///////////////////////////////
      ...
      $F = new DefinicionFormularioController(3);  // crear o cargar el formular
      $CN = $F->cuadros[3];
      $CN->def_cuadro_add_fila (9);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>110], ['region'=> [ [9,2 ,9,7]] ]);
      $CN->def_cuadro_store(['editable'=>false,'tipo_dato'=>'total_calculado'] , ['region'=> [ [9,8 ,9,10]] ]);

      $CN->def_cuadro_save() ;
/*
--buscar el id del cuadro modificado
      select df.nombre ,dc.numero, dc.nombre, dc.id_definicion_cuadro
        from definicion_formulario df
            inner join definicion_cuadro dc using(id_definicion_formulario)
        where id_definicion_formulario=32 and dc.numero=3 -- Inicial 2019 secunduaria cuadro 3


--comletar con ceros las celdas agregadas
      insert into public.datos_celda (id_definicion_celda,id_datos_cuadro,valor,updated_at)
      select dd.id_definicion_celda,dc.id_datos_cuadro, 0 as valor,now()
        from datos_cuadro dc
          inner join definicion_celda dd using(id_definicion_cuadro)
          left join datos_celda da on da.id_definicion_celda=dd.id_definicion_celda and da.id_datos_cuadro=dc.id_datos_cuadro 
        where dc.c_estado_cuadro in (80,85,90) and dd.editable=true and da.id_definicion_celda is null
          and dc.id_definicion_cuadro=281 --id del cuadro modificado
          and dd.fila=4 -- nro de la fila agragada
*/    
    ...
    static public function F2018_INICIAL($id_definicion_formulario)
    {
...
//definir un nuevo formulario
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN INICIAL';
      $F->nombre_corto='ED. INICIAL';
      $F->descripcion='Planilla Relevamiento Final 2018 de Ed. inicial';
      $F->id_periodo='82';
      $F->color='f_celeste';
...
// cuadro 3, JARDIN - CANTIDAD DE SECCIONES POR EDAD DE LA SALA SEGÚN CICLO
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Múltiple C. Maternal'        , 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,5]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Múltiple C. Jardín Inf.' , 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,9]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2018 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2018 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'F2018 - inicial cuadro 4') ;
...
// cuadro 4 - INICIAL, MATRÍCULA ATENDIDA DE MODALIDAD ARTÍSTICA Y ED. FÍSICA
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'F2018 - inicial cuadro 5') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'F2018 - inicial cuadro 5') ;
...
// cuadro 5 INICIAL, EQUIPO DE ORIENTACION ESCOLAR
      ...
      // AREA DE DATOS
      // CUADRO ANULADO EN ESTE RELEVAMIENTO
...
// cuadro 6 - INICIAL, ALUMNOS Y SECCIONES POR CICLO SEGÚN REGIMEN DE TURNOS
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'F2018 - inicial cuadro 6') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'F2018 - inicial cuadro 6') ;
...
//
// cuadro 8 INICIAL, NOMENCLATURA CATASTRAL

      $ncuadro=8;
      $F->def_formulario_add_cuadro ( [       
        'numero'=>$ncuadro,
            'nombre'=>'NOMENCLATURA CATASTRAL',
            'descripcion'=>'NOMENCLATURA CATASTRAL',
            'encabezado'=>'DATOS DE LA INFRAESTRUCTURA',
            'indicaciones'=>'Consignar los datos catastrales del lugar donde funciona la sede del establecimiento/anexo/extensión por la que contesta',
            'ayuda'=>'La nomenclatura catastral se puede obtener de varias fuentes: Impuesto Provincial –ARBA- o Municipal. /  Plano de mensura de la escuela, generalmente en la plancheta catastral figura la nomenclatura./ Mapa interactivo de ARBA, (Cartoarba) https://www.carto.arba.gov.ar/cartoArba/',
            'c_tipo_cuadro'=>1,
            'c_criterio_completitud'=>2 ,
            'ancho'=>465,
            'filas'=>2,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,2,8]] ]);

      // TITULOS DE FILAS
      $CN->def_cuadro_store(['valor_inicial'=>'PARTIDO',         'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'CIRCUNSCRIPCIÓN', 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'SECCIÓN',         'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'CHACRA',          'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'QUINTA',          'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'FRACCIÓN',        'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'MANZANA',         'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'PARCELA',         'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,8]] ]);

      // TITULOS DE COLUMNAS
      // $CN->def_cuadro_store(['valor_inicial'=>'Desayuno y Merienda Completa',  'titulo'=>true, 'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[2,1]] ]);

      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number'] , ['celdas'=> [[2,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'text'] , ['celdas'=> [[2,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'text'] , ['celdas'=> [[2,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'text'] , ['celdas'=> [[2,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'text'] , ['celdas'=> [[2,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'text'] , ['celdas'=> [[2,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'text'] , ['celdas'=> [[2,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'text'] , ['celdas'=> [[2,8]] ]);
...
// cuadro 9 INICIAL, SERVICIOS
      ...
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              ...
                                              'encabezado'=>'',
                                              'indicaciones'=>'Consignar los servicios que cuenta en la sede del establecimiento/anexo/extensión por la que contesta',
                                              'ayuda'=>'',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>2 ,
                                              'ancho'=>465,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,3,2]] ]);

      // TITULOS DE FILAS
      $CN->def_cuadro_store(['valor_inicial'=>'Situación dominial del terreno',         'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Conexión de gas',                       'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[2,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Cantidad de aulas destinadas a clases',  'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);

      // TITULOS DE COLUMNAS
      // $CN->def_cuadro_store(['valor_inicial'=>'Desayuno y Merienda Completa',  'titulo'=>true, 'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[2,1]] ]);

      // AREA DE DATOS
          // convertir en array con  $opciones = explode(';', $valor_inicial);
      $CN->def_cuadro_store(['valor_inicial'=>'Propio;Alquilado;Cedido;Otro;Ns/Nc' , 'editable'=>true,'tipo_dato'=>'radio'] , ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Red pública;Envasado;No tiene;Ns/Nc', 'editable'=>true,'tipo_dato'=>'radio'] , ['celdas'=> [[2,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number'] , ['celdas'=> [[3,2]] ]);
...
static public function F2018_PRIMARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN PRIMARIA';
      $F->nombre_corto='ED. PRIMARIA';
      $F->descripcion='Planilla Relevamiento Final 2018 de Ed. Primaria';
      $F->id_periodo='82';
      $F->color='f_celeste';
...
//
      ...
      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'1º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'3º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'4º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'5º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,10]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'6º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,12]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total','colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,14]] ]);
...
//
      ...
      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'1º','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2º','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'3º','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'4º','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'5º','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1, 6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'6º','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1, 7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Múltiple','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1, 8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total','colspan'=>1,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,9]] ]);


      // fila 2
      $CN->def_cuadro_store(['valor_inicial'=>'Secciones','titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[2,1]] ]);
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'F2018 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'F2018 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'F2018 - inicial cuadro 5') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2018 - primaria cuadro 6') ;
...
//
// //       // cuadro 7 PRIMARIA, NIVEL SECUNDARIO - CANTIDAD DE ALUMNOS DE EDUCACION SECUNDARIA CICLO SUPERIOR EN ESCUELAS DE ESB, SEGÚN ORIENTACIÓN
//


      $ncuadro=7;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                      'nombre'=>'NIVEL SECUNDARIO - CANTIDAD DE ALUMNOS DE EDUCACION SECUNDARIA CICLO SUPERIOR EN ESCUELAS DE ESB, SEGÚN ORIENTACIÓN R.302/2012',
                      'descripcion'=>'matrícula de PP Y PA',
                      'c_tipo_cuadro'=>1,
                      'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                      'ancho'=>700,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,14,10]] ]);

      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Orientaciones','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'4º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'5º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Bachiller en Arte - Visuales'            ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[9,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachiller en Arte - Danzas'              ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[10,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachiller en Arte - Literatura'          ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[11,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachiller en Arte - Música'              ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[12,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachiller en Arte - Teatro'              ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[13,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total Ciclo Superior'                    ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[14,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>110], ['region'=> [ [3,2 ,14,7]] ]);
      $CN->def_cuadro_store(['editable'=>false,'tipo_dato'=>'total_calculado'] , ['region'=> [ [3,8 ,14,10]] ]);


      $CN->def_cuadro_save() ;
      
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'F2018 - primaria cuadro 7') ;
    ...
    $CN->consistencia_save( [
                ...
                'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
                'msg3' => '',    
                'descripcion' => 'primaria-cuadro 7, Suma de columna xxx <> Total'
                ] );
...
//
//    // cuadro 8 PRIMARIA, NIVEL SECUNDARIO - CANTIDAD DE SECCIONES POR AÑO
//
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Pluriaño' , 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total' , 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,9]] ]);

      // fila 2
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. Secundaria', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[2,1]] ]);

      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>110] , ['region'=> [ [2,2 ,2,9]] ]);
    ...
    $CN->consistencia_save( [
                ...
                'msg2' => 'es distinto de suma de secciones por año',
                'msg3' => '',    
                'descripcion' => 'primaria -cuadro 8, Total x fila <> suma de secciones'
                ] ); 
    ...
    $CN->consistencia_save( [
                ...
                'cmp2' => [ 'sei' =>[ 
                                      [[[8,2,2]],   //secciones independientes 0 a 1 años Ciclo MATERNAL
                                       [[8,2,3]],   //secciones independientes 1 a 2 años Ciclo MATERNAL
                                       [[8,2,4]],   //secciones independientes 2 a 3 años Ciclo MATERNAL

                                       [[8,2,5]],   //secciones independientes 0 a 1 años Ciclo INFANTES
                                       [[8,2,6]],   //secciones independientes 1 a 2 años Ciclo INFANTES
                                       [[8,2,7]] ], //secciones independientes 2 a 3 años Ciclo INFANTES

                                    ],
                            'sea' => [  [[8,2,8]] ], // secciones agrupadas del nivel
                            'sa2' => [  [] ] // secciones agrupadas alternativas del nivel 
                          ] ,
      ...
      $CN->consistencia_save( [
                ...
                'c_estado' =>  1, // Consistencia activa
                'cmp1' => [ 'num' =>[ 
                                      [[6,0,10],[7,0,10]] //total de alumnos de ciclo básico y superior
                                    ],

                            'div' =>[ [[8,2,9]] , //secciones 1 a 6 y AG ° año, de secundaria
                                    ]
                          ],
...
//
//       // cuadro 9 PRIMARIA, MATRÍCULA ATENDIDA DE MODALIDAD ARTÍSTICA Y ED. FÍSICA
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'F2018 - primaria cuadro 9') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'F2018 - primaria cuadro 9') ;
    $CN->mapacuadro_store_c_mapa ( 110, [110],'F2018 - primaria cuadro 9') ;
    ...
    $CN->consistencia_save( [
            ...
            'cmp3' => ['d1'=> [ [ 'Nivel Primario / Ed. Física',
                       ...
                       'd2'=> [ ['2','2','2','2','2','2'],
                                ['4','4','4','4','4','4'],
                                ['4','4','4','4','4','4'],
                                ['6 y 7','6 y 7','6 y 7','6 y 7','6 y 7','6 y 7'],
                              ]
                      ],
            'msg1' => 'Los alumnos de ',
            'msg2' => 'superan los informados en cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 10, ingresar datos no 0 or on'
            ] );
...
//
//       // cuadro 10 PRIMARIA, ALUMNOS Y SECCIONES SEGÚN REGIMEN DE TURNOS
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'F2018 - primaria 10 j. mat.') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'F2018 - primaria 10 j. inf.') ;
    $CN->mapacuadro_store_c_mapa ( 110, [110],'F2018 - primaria 10 secu') ;
    ...
    $CN->consistencia_save( [
            ...
            'cmp2' => ['v2'=>[   // celdas de otros cuadros a sumar para la comparación
                                ...
                                ['cel'=>[[6,0,10],[7,0,10]]],  // ed. secundaria alum
                                ['cel'=>[[8,0,9  ]]] , // ed. secundaria sec.
            ...
            'msg2' => 'son distintos de lo informados en cuadro ',
            'msg3' => '',    
            'descripcion' => 'primaria -cuadro 10, comparacion de alumnos y secciones diferentes'
            ] );
    ...
    $CN->consistencia_save( [
            ...
            'msg2' => '', //
            'msg3' => '',    
            'descripcion' => 'primaria-cuadro 10, CANTIDAD DE ALUMNOS Y SECCIONES POR TURNO'
            ] );                      
...
//
//       // cuadro 11 PRIMARIA, ALUMNOS SEGÚN TIPO DE JORNADA:
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'F2018 - primaria cuadro 11') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'F2018 - primaria cuadro 11') ;
    $CN->mapacuadro_store_c_mapa ( 110, [110],'F2018 - primaria cuadro 11') ;
    ...
    $CN->consistencia_save( [
            ...
            'msg2' => '',
            'msg3' => '',    
            'descripcion' => 'primaria 11, ingresar datos no 0 or on'
            ] );
    ...
    $CN->consistencia_save( [
            ...
            'msg3' => '',    
            'descripcion' => 'primaria-cuadro 11, comparacion de alumnos diferentes'
            ] );
      ...
      //
      // // cuadro 12 PRIMARIA, NOMENCLATURA CATASTRAL
      //
      $ncuadro=12;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
//
// //       // cuadro 12 PRIMARIA, CANTIDAD DE ALUMNOS EN 1° AÑO SEGÚN SU ASISTENCIA A JARDÍN
//
    ...
    //   // DEFINIR mapa_cuadro DEL CUADRO
    //   $CN->mapacuadro_store_c_mapa ( 102, [102],'F2018 - primaria cuadro 6') ;
    ...
    //             'msg3' => '',    
    //             'descripcion' => 'primaria -cuadro 12, comparacion de alumnos 1° año diferentes'
    //             ] );
...
//
// //       // cuadro 13 PRIMARIA, EQUIPO DE ORIENTACION ESCOLAR
//
...
//                 'msg2' => '',
//                 'msg3' => '',    
//                 'descripcion' => 'primaria-cuadro 13, ingresar datos no 0 or on'
//                 ] );
...
//                 'cmp1' => ['chk'=> [ [[2,2],[3,2],[4,2],[5,2]] ], // conjunto de celdas chk, a validar (1 sola puede ser tildada x vez)
//                           ],
//                 'cmp2' => ['ckp' => [ [13,5,2] ],     // ckp (check padre) celdas que habilitan la carga/tilde de celdas hijos (chi)
//                                                       // puede estar en otro cuadro   
//                            'chi'=> [ [[6,2]] ] // chi (celdas hijos) celdas habilitadas x el tilde de ckp
//                           ],
//                 'cmp3' => [ 'mch' => [ 'Solo una opción de EOE puede ser seleccionada'] , // mensaje para el grupo de celdas chk
...
//                 'msg2' => '',
//                 'msg3' => '',    
//                 'descripcion' => 'primaria -cuadro 13, validacion de E.O.E'
//                 ] );
...
static public function F2018_SECUNDARIA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN SECUNDARIA / POLIMODAL / MEDIA';
      $F->nombre_corto='ED. SECUNDARIA';
      $F->descripcion='Planilla Relevamiento Final 2018 de Ed. Secundaria';
      $F->id_periodo='82';
      $F->color='f_celeste';
      ...
      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Modalidad','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'1º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'3º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Aceleración','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,8]] ]);  
      $CN->def_cuadro_store(['valor_inicial'=>'Total','colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,10]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2018 - secundaria cuadro 2') ;
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2018 - secundaria cuadro 3') ;
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Bach. en música con esp. en realización musical en vivo - instrumento'
                                                                                                                            ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=>[[9,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bach. en música con esp. en realización musical en vivo - música popular'
                                                                                                                            ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=>[[10,1]] ]);
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,24,12]] ]);

      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Especialidad','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'4º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'5º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'6º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,6]] ]); 
      $CN->def_cuadro_store(['valor_inicial'=>'7º','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,8]] ]);                                 
      $CN->def_cuadro_store(['valor_inicial'=>'Total','colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,10]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Técnico en producción agropecuaria' ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[23,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total Ciclo Superior'               ,'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[24,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>110], ['region'=> [ [ 4, 2,20,9], [22, 2,24,9] ] ]);
      $CN->def_cuadro_store(['editable'=>false,'tipo_dato'=>'total_calculado'] , ['region'=> [ [ 4,10 ,20,12], [22,10 ,24,12]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2018 - secundaria cuadro 5') ; //110=Común - Secundaria Completa req. 6 años 
      ...
      //
      // //       // cuadro 6 SECUNDARIA-> CANTIDAD DE ALUMNOS DE POLIMODAL DE CUATRO AÑOS. Resoluciones Nº12.468/99 y 12.763/99 Vespertino/Nocturno
      //
      ...
      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Modalidades','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'1° Polimodal','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2° Polimodal','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'3° Polimodal','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,6]] ]); 
      $CN->def_cuadro_store(['valor_inicial'=>'4° Polimodalº','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,8]] ]);                                 
      $CN->def_cuadro_store(['valor_inicial'=>'Total','colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'],
                            ['celdas'=> [[1,10]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2018 - secundaria cuadro 5') ;  //112=Común - Polimodal
      ...
      // //
      // //       // cuadro 7 SECUNDARIA-> CANTIDAD DE ALUMNOS DE BACHILLERATO PARA ADULTOS, PLAN DE 3 AÑOS POR AÑO Y SEXO SEGÚN ESPECIALIDAD
      // //       
      ...
      // //
      // //       // cuadro 8 SECUNDARIA-> CANTIDAD DE ALUMNOS DE BACHILLERATO PARA ADULTOS, PLAN DE 4 AÑOS POR AÑO Y SEXO SEGÚN ESPECIALIDAD
      // //       
      ...
      // //
      // //       // cuadro 9 SECUNDARIA-> CANTIDAD DE ALUMNOS DE SISTEMA DUAL POR AÑO Y SEXO SEGÚN ESPECIALIDAD Y TÍTULO
      // //       
      ...
      $CN->def_cuadro_store(['c_mapa'=>110] , [ 'region'=> [ [3,1,3,10], [4,2,4,10] ] ]);
      ...
      // //
      // //       // cuadro 10 SECUNDARIA->- CANTIDAD DE ALUMNOS DE TRAYECTOS TÉCNICOS PROFESIONALES POR AÑO Y SEXO SEGÚN TRAYECTO Y MODALIDAD
      // //       
      ...
      //fila 2
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. secundaria orientada (R.302/12)', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[2,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. secundaria técnica (R.302/12)', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. secundaria agropecuaria (R.302/12)', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. secundaria artística (polivalentes de arte)', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[5,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Polimodal de 4 años', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[6,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachillerato para adultos, plan de 3 años', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[7,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachillerato para adultos, plan de 4 años', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[8,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Grupos de bachillerato para adultos semipresenciales o a distancia', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[9,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Sistema dual', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[10,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Grupos de TTP (trayectos téc. prof.)', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[11,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Grupos de Itinerarios Formativos', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[12,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Cursos de capacitación post-primaria', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[13,1]] ]);                                              
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,'estilos'=>'titulo2', 
                                        'tipo_dato'=>'text'], ['celdas'=> [[14,1]] ]);
      ...
      $CN->def_cuadro_store(['c_mapa'=>110], ['region'=> [ [2,2,5,11]] ]); //  110=Comun Secundaria.
      $CN->def_cuadro_store(['c_mapa'=>112], ['region'=> [ [6,2,6,11]] ]); // 112=Común - Polimodal 
      $CN->def_cuadro_store(['c_mapa'=>144], ['region'=> [ [7,2,9,11]] ]); // 144=Adultos - Secundaria Completa
      $CN->def_cuadro_store(['c_mapa'=>110], ['region'=> [ [10,2,10,11]] ]); //  110=Comun Secundaria.
      $CN->def_cuadro_store(['c_mapa'=>113], ['region'=> [ [11,2,11,11]] ]); //  113="Común - Trayecto técnico profesional ".
      ...
      //celdas sombreadas
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'number'] ,
            ['region'=> [ [4,10,13,10],[6,6,11,9],[12,2,12,4],[13,5,13,9] ] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'number'] ,
            ['celdas'=> [ [2,8],[7,5],[9,5],[10,5],[12,9]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110], 'secundaria c 13') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112], 'secundaria c 13') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144], 'secundaria c 13') ;
      $CN->mapacuadro_store_c_mapa ( 113, [113], 'secundaria c 13') ;
      $CN->mapacuadro_store_c_mapa ( 114, [114], 'secundaria c 13') ;
      $CN->mapacuadro_store_c_mapa ( 146, [146], 'secundaria c 13') ;
      ...
      $CN->consistencia_save( [
                ...
                'cmp1' => [ 'alu' =>[ [[[2,3,2],[2,3,3]],[[2,3,4],[2,3,5]],[[2,3,6],[2,3,7]], //ciclo basico orientado
                                      ...
                                      ['r'=>[[5,22,2,23,3]]],['r'=>[[5,22,4,23,5]]],['r'=>[[5,22,6,23,7]]],['r'=>[[5,22,8,23,9]]] ],  // ciclo superior agraria

                                      [[[4,0,2],[4,0,3]],[[4,0,4],[4,0,5]],[[4,0,6],[4,0,7]], //ciclo basico artistico
                                      [[4,0,8],[4,0,9]],[[4,0,10],[4,0,11]],[[4,0,12],[4,0,13]] ], //ciclo sup. artistico

                                      [[[6,0,2],[6,0,3]],[[6,0,4],[6,0,5]],[[6,0,6],[6,0,7]],[[6,0,8],[6,0,9]] ],// polimodal 1° a 4° v+m
                                      [[[7,0,3],[7,0,4]],[[7,0,5],[7,0,6]],[[7,0,7],[7,0,8]] ],// bach. adultos 3 años 1a3 v+m
                                      [[[8,0,2],[8,0,3]],[[8,0,4],[8,0,5]],[[8,0,6],[8,0,7]],[[8,0,8],[8,0,9]] ],// bach. adul 4 años 1a4 v+m
                                      [[[9,0,2],[9,0,3]],[[9,0,4],[9,0,5]],[[9,0,6],[9,0,7]] ],// sistema dual 1a3 v+m

                                      [[[10,0,2],[10,0,3]],[[10,0,4],[10,0,5]],[[10,0,6],[10,0,7]],[[10,0,8],[10,0,9]] ],// TTP 1a4 v+m
                ...
                'cmp2' => [ 'sei' =>[ [[[13,2,2]],[[13,2,3]],[[13,2,4]], //Secciones c. basico orientada
                                      ...
                                      [[[13,4,2]],[[13,4,3]],[[13,4,4]], //Secciones c. agraria 1 a 3
                                      [[13,4,5]],[[13,4,6]],[[13,4,7]],[[13,4,8]] ], //secciones c. agraria 4 a 7

                                      [[[13,5,2]],[[13,5,3]],[[13,5,4]], //Secciones c.b. artistica 1 a 3
                                      [[13,5,5]],[[13,5,6]],[[13,5,7]],[[13,5,8]] ], //secciones c.s. artistica 4 a 7

                                      [[[13,6,2]],[[13,6,3]],[[13,6,4]],[[13,6,5]] ], //Secciones Polimodal 1° a 4°

                                      [[[13,7,2],[13,9,2]],[[13,7,3],[13,9,3]],[[13,7,4],[13,9,4]] ], //Secciones bach. adultos 3 años (presencial y a distancia)
                                      [[[13,8,2]],[[13,8,3]],[[13,8,4]],[[13,8,5]] ], //Secciones bach. adultos 3 años (presencial y a distancia)
                                      [[[13,10,2]],[[13,10,3]],[[13,10,4]] ], //Secc. Sis. Dual 1a3 años  
                                      [[[13,11,2]],[[13,11,3]],[[13,11,4]],[[13,11,5]] ], //Secc. TTP. 1a4 años
                            ...
                            'sea' => [ [[13,2,9]], // secciones agrup ciclo orientado
                                      ...
                                      [[13,4,9]],  // secciones agrup agraria
                                      [[13,5,9]],  // secciones agrup artistica
      ...
      $CN->consistencia_save( [
            ...
            ['r'=>[[2,5,2,5,7],[5,22,2,23,9]] ], // ciclo basico y superior agrario
            ...
            [[13,4,2],[13,4,3],[13,4,4], [13,4,5],[13,4,6],[13,4,7],[13,4,8], [13,4,9] ], //S. agraria 1 a 7

            [[13,5,2],[13,5,3],[13,5,4], [13,5,5],[13,5,6],[13,5,7],[13,5,8], [13,5,9] ], //S. art. 1 a 7
            [[13,6,2]],[[13,6,3]],[[13,6,4]],[[13,6,4]], //Secciones Polimodal 1° a 4°
            
            [[13,7,2],[13,9,2]],[[13,7,3],[13,9,3]],[[13,7,4],[13,9,4]], //Bach. adultos 3 años (presencial y a distancia)
            [[13,8,2]],[[13,8,3]],[[13,8,4]],[[13,8,5]], //bach. adultos 4 años
            [[13,10,2]],[[13,10,3]],[[13,10,4]], //Secc. Sis. Dual 1a3 años  
            [[13,11,2]],[[13,11,3]],[[13,11,4]],[[13,11,5]], //Secc. TTP. 1a4 años
            [[13,12,5]],[[13,12,6]],[[13,12,7]],[[13,12,8]], //IF 4a7
            [[13,13,2]],[[13,13,3]],[[13,13,4]], //Cursos de Cap. 1a3
                ...
                'cmp2' => [ 'min' =>[ 10, //secciones total orient.
                            ...
                            'max' =>[ 45, //secciones total, sec orient 
                ...
                'cmp3' => [ 'des' =>  ['Secundaria Orientada',
                                      ...
                                      '1° Sist. Dual','2° Sist. Dual','3° Sist. Dual',
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2018 - secundaria cuadro 16') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2018 - secundaria cuadro 16') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2018 - secundaria cuadro 16') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2018 - secundaria cuadro 16') ;
      ...
      //                              ['reg'=>[[2,3,2,3,9],[3,0,2,0,7]] ], // ciclo basico y superior orientado (con CESAJ)
                      ['cel'=>[[2,3,12], [3,0,10]] ], // alumnos ciclo basico y superior orientado (con CESAJ)

      //                              ['reg'=>[[2,4,2,4,7],[5, 4,2,20,9]] ], // ciclo basico y superior tecnico
                      ['cel'=>[[2,4,12]] , 'reg'=>[[5, 4,12,20,12]] ], // alumnos ciclo basico y superior tecnico

      //                              ['reg'=>[[2,5,2,5,7],[5,22,2,23,9]] ], // ciclo basico y superior agrario
                      ['cel'=>[[2,5,12]], 'reg'=>[[5,22,12,23,12]] ], // alumnos ciclo basico y superior agrario

                                ['cel'=>[[4,0,16]]], // ciclo basico y superior de arte
                                ['cel'=>[[6,0,12]]],// polimodal 1° a 4° v+m

                                ['cel'=>[[7,0,11]]],// bach. adultos 3 años 1a3 v+m
                                ['cel'=>[[8,0,12]]],// bach. adul 4 años 1a4 v+m
                                ['cel'=>[[9,0,10]]],// sistema dual 1a3 v+m
      ...
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2018 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2018 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2018 - secundaria cuadro 17') ;
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2018 - secundaria cuadro 17') ;
      ...
      $CN->consistencia_save( [
            ...
            'cmp2' => ['v2'=>[   // celdas de otros cuadros a sumar para la comparación
                      ...
                      ['cel'=>[[13,2,11]]],// Secciones
                          ...
                          //     ['reg'=>[[2,4,2,4,7],[5, 4,2,20,9]] ], // alumnos ciclo basico y superior tecnico
                      ['cel'=>[[2,4,12]] , 'reg'=>[[5, 4,12,20,12]] ], // alumnos ciclo basico y superior tecnico
                                ['cel'=>[[13,3,11]]],// Secciones

                          //     ['reg'=>[[2,5,2,5,7],[5,22,2,23,9]] ], // alumnos ciclo basico y superior agrario
                      ['cel'=>[[2,5,12]], 'reg'=>[[5,22,12,23,12]] ], // alumnos ciclo basico y superior agrario
                                ['cel'=>[[13,4,11]]],// Secciones

                                ['cel'=>[[4,0,16]]], // alumnos ciclo basico y superior de arte
                                ['cel'=>[[13,5,11]]],// Secciones

                                ['cel'=>[[6,0,12]]],// alumnos polimodal 1° a 4° v+m
                                ['cel'=>[[13,6,11]]],// Secciones


                                ['cel'=>[[7,0,11]]],// alumnos bach. adultos 3 años 1a3 v+m
                                ['cel'=>[[13,7,11],[13,9,11]]],// Secciones (con las semipresenciales)

                                ['cel'=>[[8,0,12]]],// alumnos bach. adul 4 años 1a4 v+m
                                ['cel'=>[[13,8,11]]],// Secciones

                                ['cel'=>[[9,0,10]]],// alumnos sistema dual 1a3 v+m
                                ['cel'=>[[13,10,11]]],// Secciones
            ...
            'msg2' => 'son distintos de lo informados en cuadro ',
            'msg3' => '',    
            'descripcion' => 'secundaria cuadro 17, comparacion de alumnos y secciones diferentes'
            ] );
      ...
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Tipo de Jornada','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1',
        'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. Sec. Orientada','colspan'=>2,  'titulo'=>true,'estilos'=>'titulo1',
        'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. Sec. Técnica','colspan'=>2,  'titulo'=>true,'estilos'=>'titulo1',
        'tipo_dato'=>'text'], ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. Sec. Agropecuaria','colspan'=>2,  'titulo'=>true,'estilos'=>'titulo1',
        'tipo_dato'=>'text'], ['celdas'=> [[1,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ed. Sec. Artísitica (poliv. de arte)','colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 
        'tipo_dato'=>'text'], ['celdas'=> [[1,8]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Polimodal de 4 años','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 
        'tipo_dato'=>'text'], ['celdas'=> [[1,10]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachillerato para Adultos (3 años)','rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo1', 
        'tipo_dato'=>'text'], ['celdas'=> [[1,11]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Bachillerato para Adultos (4 años)','rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo1', 
        'tipo_dato'=>'text'], ['celdas'=> [[1,12]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Sistema Dual','rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo1', 
        'tipo_dato'=>'text'], ['celdas'=> [[1,13]] ]);


      // fila 2
      $CN->def_cuadro_store(['valor_inicial'=>'Ciclo Básico','titulo'=>true,'estilos'=>'titulo1', 
        'tipo_dato'=>'text'], ['celdas'=> [[2,2],[2,4],[2,6],[2,8], ] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ciclo Superior','titulo'=>true,'estilos'=>'titulo1', 
        'tipo_dato'=>'text'], ['celdas'=> [[2,3],[2,5],[2,7],[2,9], ] ]);



      //filas 3 a 7
      $CN->def_cuadro_store(['valor_inicial'=>'Jornada Simple (hasta 29 hs, semanales)', 'titulo'=>true,
        'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Jornada Extendida (30 hs, semanales)', 'titulo'=>true,
        'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Jornada Agro-técnica (35 a 39 hs. Semanales)', 'titulo'=>true,
        'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[5,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Jornada Doble (40 hs, semanales)', 'titulo'=>true,
        'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[6,1]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,
        'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[7,1]] ]);
      ...
      $CN->consistencia_save( [
            ...
            'cmp2' => ['v2'=>[   // celdas de otros cuadros a sumar para la comparación
                      ...
                      ['reg'=>[[5, 4,12,20,12]] ], // alumnos ciclo superior tecnico

                      ['cel'=>[[2,5,12]] ], // alumnos ciclo basico agrario
                      ['reg'=>[[5,22,12,23,12]] ], // alumnos ciclo superior agrario
      ...
      //
      // // cuadro 19 SECUNDARIAL, NOMENCLATURA CATASTRAL
      //
      $ncuadro=19;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
      ...
      //
      // // cuadro 20 SECUNDARIA, SERVICIOS
      //
      $ncuadro=20;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'SERVICIOS',
...
static public function F2018_SUPERIOR($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN SUPERIOR';
      $F->nombre_corto='ED. SUPERIOR';
      $F->descripcion='Planilla Relevamiento Final 2018 de Ed. Superior';
      $F->id_periodo='82';
      $F->color='f_verde';
...
//       //
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Varón',
                                            'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,2],[2,4],[2,6],[2,8],[2,10],[2,12]  ] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Mujer',
                                            'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,3],[2,5],[2,7],[2,9],[2,11],[2,13]  ] ]);
...
// //       //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'F2018 - SUPERIOR cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 117, [117],'F2018 - SUPERIOR cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1115, [115,117],'F2018 - SUPERIOR cuadro 5') ;
      ...
      //
      // // cuadro 6 SUPERIOR, NOMENCLATURA CATASTRAL
      //
      $ncuadro=6;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
///////////////////////////////
     ...
     */
    static public function F2018_EPA($id_definicion_formulario)
    {
...
///////////////////////////////
        ...
        $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN PRIMARIA DE ADULTOS';
        $F->nombre_corto='ED. PRIMARIA DE ADULTOS';
        $F->descripcion='Planilla Relevamiento Final 2018 de EPA';
        $F->id_periodo='82';
        $F->color='f_violeta';
...
//
        ...
        // inicializar las celdas del cuadro
        $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],
                              ['region'=> [ [1,1,3,9]] ]);

        // TITULOS DE FILAS
        
        $CN->def_cuadro_store(['valor_inicial'=>'Alfabetización (1º ciclo)',
                                             'colspan'=>2, 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
        $CN->def_cuadro_store(['valor_inicial'=>'Formación Integral (2º ciclo)',
                                             'colspan'=>2, 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,3]] ]);
        $CN->def_cuadro_store(['valor_inicial'=>'Formación por Proyectos (3° ciclo)',
                                             'colspan'=>2, 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,5]] ]);
        $CN->def_cuadro_store(['valor_inicial'=>'Total',
                                             'colspan'=>3, 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,7]] ]);
        ...
        $CN->def_cuadro_store(['valor_inicial'=>'Varón',
                                            'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,1],[2,3],[2,5],[2,7]] ]);
        $CN->def_cuadro_store(['valor_inicial'=>'Mujer',
                                            'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,2],[2,4],[2,6],[2,8]] ]);
...
//
// cuadro 4 EPA-> CANTIDAD DE SECCIONES / GRUPOS DE EPA SEGÚN MODO DE DICTADO Y CICLO.
//
        $ncuadro=4;
        $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'CANTIDAD DE SECCIONES / GRUPOS DE EPA SEGÚN MODO DE DICTADO Y CICLO.',
      ...
      //
      // // cuadro 5 EPA, NOMENCLATURA CATASTRAL
      //
      $ncuadro=5;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
static public function F2018_CENS($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN DE ADULTOS (CENS)';
      $F->nombre_corto='ED. DE ADULTOS (CENS)';
      $F->descripcion='Planilla Relevamiento Final 2018 de CENS.';
      $F->id_periodo='82';
      $F->color='f_violeta';
...
// //
// //       // cuadro 3 CENS-> CANTIDAD DE ALUMNOS DE MODALIDAD PRESENCIAL
// //


      $ncuadro=3;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                      'nombre'=>'CANTIDAD DE ALUMNOS DE MODALIDAD PRESENCIAL',
...
//
//       // cuadro 4 CENS-> CANTIDAD DE ALUMNOS DE MODALIDAD SEMIPRESENCIAL Resol. 737/07
//

      $ncuadro=4;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                      'nombre'=>'CANTIDAD DE ALUMNOS DE MODALIDAD SEMIPRESENCIAL Resol. 737/07',
...
//
// //   cuadro 5 CENS-> CANTIDAD DE SECCIONES SEGÚN MODO DE DICTADO Y AÑO
//
      $ncuadro=5;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,3,6]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Modularizado','titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total','titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,6]] ]);
      
      //fila 2 Y 3

      $CN->def_cuadro_store(['valor_inicial'=>'Presencial' , 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[2,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Semipresencial Resol. 737/07' , 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);

      
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>144] , ['region'=> [ [2,2 ,3,6]] ]);

      // SOMBREAR CELDAS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'number'],
                                 ['region'=>[ [3,2,3,4]], 'celdas'=>[[2,5]] ]);

      $CN->def_cuadro_save() ;

      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'F2018 - CENS cuadro 5') ;
      ...
      $CN->consistencia_save( [
                ...
                'msg3' => '',    
                'descripcion' => 'CENS -cuadro 5, Total x fila <> suma de AÑOS'
                ] );
      ...
      $CN->consistencia_save( [
                ...
                'c_estado' =>  1, // Consistencia activa
                'cmp1' => [ 'alu' =>[ 
                                      [[[3,0,2],[3,0,3]], //alumnos 1 año V+M  de PRESENCIAL
                                       [[3,0,4],[3,0,5]], //alumnos 2 año V+M  de PRESENCIAL
                                       [[3,0,6],[3,0,7]], //alumnos 3 año V+M  de PRESENCIAL
                                      ], //alumnos DE PRESENCIAL
                                      [[[4,0,2],[4,0,3]], //alumnos V+M  de SEMIPRESENCIAL
                                      ], //alumnos SEMIPRESENCIAL

                                  ]
                          ],
                'cmp2' => [ 'sei' =>[ 
                                      [[[5,2,2]],   //secciones independientes 1 años PRESENCIAL
                                       [[5,2,3]],   //secciones independientes 2 años PRESENCIAL
                                       [[5,2,4]],   //secciones independientes 3 años PRESENCIAL
                                      ], //secciones independientes  PRESENCIAL

                                      [[[5,3,5]],   //secciones independientes SEMIPRESENCIAL
                                      ], //secciones independientes SEMIPRESENCIAL
      ...
      $CN->consistencia_save( [
                ...
                'c_estado' =>  1, // Consistencia activa
                'cmp1' => [ 'num' =>[ 
                                      [[3,0,2 ],[3,0,3 ]], //alumnos de cuadro 3 mod. presencial
                                      [[3,0,4 ],[3,0,5 ]],
                                      [[3,0,6 ],[3,0,7 ]],

                                      [[4,0,2 ],[4,0,3 ]], //alumnos de cuadro 4 mod. semipresencial
                                    ],

                            'div' =>[ [[5,2,2]], [[5,2,3]], [[5,2,4]],  //secc. 1,2,3, + AG ° año, de carreras
                                      [[5,3,5]], //secc. 1,2,3,4,5 + AG ° año, de cursos                                   
                                    ]
                          ],
                'cmp2' => [ 'min' =>[ 15,15,15, //presencial
                                      15 // semipresencial                                      
                                    ],
                            'max' =>[ 45,45,45, //presencial
                                      80  //semipresencial                                      
                                    ]
                          ] ,

                'cmp3' => [ 'des' =>  [ 'cuadro 3, 1° año','cuadro 3, 2°año','cuadro 3, 3°año',                            
                                        'cuadro 4, modalidad semipresencia'
                                      ] 
                          ],  
...
//
// //       // cuadro 6 CENS-> CANTIDAD DE ALUMNOS Y COMISIONES DE PLANES FINES
// 
      ...
      $CN->consistencia_save( [
                ...
                'c_estado' =>  1, // Consistencia activa
                'cmp1' => [ 'alu' =>[ 
                                      [[[6,2,2],[6,2,3]], //alumnos Línea deudores de materias V+M
                                       [[6,3,2],[6,3,3]], //alumnos Línea trayectos educativos V+M
                                      ]
                                    ]
                          ],
                'cmp2' => [ 'sei' =>[ 
                                      [[[6,2,5]],   //secciones Línea deudores de materias
                                       [[6,3,5]],   //secciones Línea trayectos educativos
      ...
      $CN->consistencia_save( [
                ...
                'c_estado' =>  1, // Consistencia activa
                'cmp1' => [ 'num' =>[ 
                                      [[6,2,2 ],[6,2,3 ]], //alumnos 1
                                      [[6,3,2 ],[6,3,3 ]], //alumnos 2
                                    ],

                            'div' =>[ [[6,2,5]], //secc. 1, + AG ° año, 
                                      [[6,3,5]], //secc. 2, + AG ° año                                   
                                    ]
                          ],
                'cmp2' => [ 'min' =>[ 15,15,15, //presencial
      ...
      //
      // // cuadro 7 CENS, NOMENCLATURA CATASTRAL
      //
      $ncuadro=7;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
static public function F2018_ESPECIAL($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN ESPECIAL';
      $F->nombre_corto='ED. ESPECIAL';
      $F->descripcion='Planilla Relevamiento Final 2018 de Especial';
      $F->id_periodo='82';
      $F->color='f_rosa';
...
//
// //       // cuadro 3, ESPECIAL - ALUMNOS MATRICULADOS EN EL NIVEL INICIAL (ATDI) 0 A 3 AÑOS
//

      $ncuadro=3;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'ALUMNOS MATRICULADOS EN EL NIVEL INICIAL (ATDI) 0 A 3 AÑOS',
                                              'descripcion'=>'matrícula estimulación temprana',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                                              'ancho'=>336,
                                              'filas'=>5,
      ...
      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Clase','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,4]] ]);
          //filas 3 y 4
      $CN->def_cuadro_store(['valor_inicial'=>'Con patología instalada', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Con riesgo ambiental', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[5,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>121] , ['region'=> [ [3,2,5,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>121] , ['region'=> [ [3,4,5,4]] ]);


      $CN->def_cuadro_save() ;

      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 121, [121],'especial cuadro 3') ;
      ...
      $CN->consistencia_save( [
                      ...
                      'msg2' => '',
                      'msg3' => '',    
                      'descripcion' => 'especial -cuadro 3, calcular Total x fila <> suma de varón + mujer'
                      ] );
...
//
// //       // cuadro 4, ESPECIAL - ALUMNOS MATRICULADOS EN LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)
//

      $ncuadro=4;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                      'nombre'=>'ALUMNOS MATRICULADOS EN LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)',
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,11,14]] ]);

      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Clase','rowspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Nivel Inicial', 'rowspan'=>2,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Post-Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'rowspan'=>2,'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,12]] ]);
      
      //fila 2

      $CN->def_cuadro_store(['valor_inicial'=>'1° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'1° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,10]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Sordos e Hipoacúsicos', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Ciegos y Disminuidos Visuales', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[5,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Discapacitados Motores y Neurolocomotores', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[6,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Trastornos Emocionales Severos', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[7,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Retardo Mental', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[8,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Trastornos en el Desarrollo del Lenguaje y la Comunic.', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[9,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Multimpedidos', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[10,1]] ]);
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>122] , ['region'=> [ [4,2,11,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>123] , ['region'=> [ [4,4,11,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>131] , ['region'=> [ [4,8,11,11]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>1122] , ['region'=> [ [4,12,11,14]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 122, [122],'especial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 123, [123],'especial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 131, [131],'especial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa (1122, [122,123,131],'especial cuadro 4') ;
      ...
      $CN->consistencia_save( [
                ...
                'cmp1' => [] ,
                'cmp2' => [] ,
                'cmp3' => ['tit' => [   '2' => 'Nivel Inicial / Varón ',
                                        '3' => 'Nivel Inicial / Mujer ',
                                        '4' => 'Ed. Primaria / 1° Ciclo / Varón ',
                                        '5' => 'Ed. Primaria / 1° Ciclo / Mujer ',
                                        '6' => 'Ed. Primaria / 2° Ciclo / Varón ',
                                        '7' => 'Ed. Primaria / 2° Ciclo / Mujer ',
                                        '8' => 'Ed. Post-Primaria / 1° Ciclo / Varón ',
                                        '9' => 'Ed. Post-Primaria / 1° Ciclo / Mujer ',
                                        '10' => 'Ed. Post-Primaria / 2° Ciclo / Varón ',
                                        '11' => 'Ed. Post-Primaria / 2° Ciclo / Mujer ',
                                        '12' =>  'Total / Varón ',
                                        '13' => 'Total / Mujer ',
                                        '14' => 'Total '
                                    ]
                ...
                'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
                'msg3' => '',    
                'descripcion' => 'especial-cuadro 4, Suma de columna xxx <> Total'
                ] );                      
      ...
      $CN->consistencia_save( [
                ...
                'msg2' => '',
                'msg3' => '',    
                'descripcion' => 'especial -cuadro 4, Total  varon x fila <> suma de varónes'
                ] );
      $CN->consistencia_save( [
                      'numero' => 4,
                      'c_tipo_consistencia' => 11, // cuadros dependientes
...
//
// //       // cuadro 5, ESPECIAL - ALUMNOS MATRICULADOS, DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO
...
//
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,8,15]] ]);

      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Clase','rowspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Condición','rowspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Nivel Inicial', 'rowspan'=>2,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Post-Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,9]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'rowspan'=>2,'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,13]] ]);
      
      //fila 2

      $CN->def_cuadro_store(['valor_inicial'=>'1° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'1° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,9]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,11]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Impedidos de concurrir al Servicio Ordinario (Domiciliarios)', 'rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Permanente', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[4,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Transitorio', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[5,2]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Impedidos de concurrir al Servicio Ordinario (Hospitalarios)', 'rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[6,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Permanente', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[6,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Transitorio', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'colspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[8,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>155] , ['region'=> [ [4,3,8,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>156] , ['region'=> [ [4,5,8,8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>157] , ['region'=> [ [4,9,8,12]] ]);
      // $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number' ] , ['region'=> [ [4,13,8,15]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>1155 ] , ['region'=> [ [4,13,8,15]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 155, [152,155],    'especial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 156, [153,156,158],'especial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 157, [154,157,159],'especial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1155, [152,153,154,155,156,157,158,159],'especial cuadro 5') ;
      ...
      $CN->consistencia_save( [
                ...
                'cmp1' => [] ,
                'cmp2' => [] ,
                'cmp3' => ['tit' => [   '3' => 'Nivel Inicial / Varón ',
                                        '4' => 'Nivel Inicial / Mujer ',
                                        '5' => 'Ed. Primaria / 1° Ciclo / Varón ',
                                        '6' => 'Ed. Primaria / 1° Ciclo / Mujer ',
                                        '7' => 'Ed. Primaria / 2° Ciclo / Varón ',
                                        '8' => 'Ed. Primaria / 2° Ciclo / Mujer ',
                                        '9' => 'Ed. Post-Primaria / 1° Ciclo / Varón ',
                                        '10' => 'Ed. Post-Primaria / 1° Ciclo / Mujer ',
                                        '11' => 'Ed. Post-Primaria / 2° Ciclo / Varón ',
                                        '12' => 'Ed. Post-Primaria / 2° Ciclo / Mujer ',
                                        '13' =>  'Total / Varón ',
                                        '14' => 'Total / Mujer ',
                                        '15' => 'Total '
                                    ]
      ...
      $CN->consistencia_save( [
               'numero' =>  3,
                ...
                'c_estado' =>  1 , // Consistencia activa
                'cmp1' => ['col'=>[13,14,15] ] ,
                'cmp2' => ['scol'=>[[3,5,7,9,11],[4,6,8,10,12],[13,14]]] ,
                'cmp3' => [],
      ...
      $CN->consistencia_cantidad_x_cuadro(4); // por si hay que eliminar consistencias viejas
//
// //       // cuadro 6, ESPECIAL - ALUMNOS MATRICULADOS EN FORMACIÓN LABORAL (EN SEDE)
//


      $ncuadro=6;
      $F->def_formulario_add_cuadro  ( [   'numero'=>$ncuadro,
                                              'nombre'=>'ALUMNOS MATRICULADOS EN FORMACIÓN LABORAL (EN SEDE)',
                                              'descripcion'=>'matrícula estimulación tempformación Laboral en sede',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                                              'ancho'=>528,
                                              'filas'=>3,
      ...
      //filas 3 y 4
      $CN->def_cuadro_store(['valor_inicial'=>'Formación Laboral (Formación Profesional)', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>171] , ['region'=> [ [3,2,3,5]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 171, [171],    'especial cuadro 6') ;
      ...
      $CN->consistencia_save( [
                                    ...
                                    'msg2' => 'es distinto de suma de varones y mujeres ',
                                    'msg3' => '',    
                                    'descripcion' => 'especial -cuadro 6, Total x fila <> suma de varón + mujer'
                                    ] );
...
//
// //       // cuadro 7, ESPECIAL - ALUMNOS MATRICULADOS EN LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)
//
      $ncuadro=7;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'ALUMNOS MATRICULADOS EN LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)',
                                              'descripcion'=>'matrícula de niveles en integración',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // debe TENER DATOS
                                              'ancho'=>1122,
                                              'filas'=>11,
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [4,2,11,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [4,4,11,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [4,8,11,11]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>134] , ['region'=> [ [4,12,11,14]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 134, [134],    'especial cuadro 7') ;
      ...
      $CN->consistencia_save( [
                ...
                'msg2' => '',
                'msg3' => '',    
                'descripcion' => 'especial-cuadro 7, ingresar datos no 0 or on'
                ] );
      ...
      $CN->consistencia_save( [
        ...
        $CN->consistencia_cantidad_x_cuadro(4); // por si hay que eliminar consistencias viejas    
//
// //       // cuadro 8, ESPECIAL - ALUMNOS MATRICULADOS EN FORMACIÓN LABORAL (EN INTEGRACIÓN)
//
      $ncuadro=8;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'ALUMNOS MATRICULADOS EN FORMACIÓN LABORAL (EN INTEGRACIÓN)',
                                              'descripcion'=>'matrícula estimulación tempformación Laboral en integración',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // debe TENER DATOS
                                              'filas'=>3,
                                               'ancho'=>528,
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [3,2,3,5]] ]);
      ...
      $CN->consistencia_save( [
                                    ...
                                    'msg2' => 'es distinto de suma de varones y mujeres ',
                                    'msg3' => '',    
                                    'descripcion' => 'especial -cuadro 8, Total x fila <> suma de varón + mujer'
                                    ] );
...
//
// //       // cuadro 9, ESPECIAL -ALUMNOS MATRICULADOS EN ORIENTACION MANUAL Y PRE-TALLER
//
      $ncuadro=9;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'ALUMNOS MATRICULADOS EN ORIENTACION MANUAL Y PRE-TALLER',
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>170] , ['region'=> [ [3,2,5,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>170] , ['region'=> [ [3,4,5,4]] ]);
      
      $CN->def_cuadro_store(['c_mapa'=>136]  , ['region'=> [ [3,2,3,5]] ]);
      $CN->def_cuadro_store(['c_mapa'=>138]  , ['region'=> [ [4,2,4,5]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 136, [136],     'especial cuadro 9') ;
      $CN->mapacuadro_store_c_mapa ( 138, [138],     'especial cuadro 9') ;
      $CN->mapacuadro_store_c_mapa (1136, [136,138], 'especial cuadro 9') ;
      ...
      $CN->consistencia_save(
          [
            ...
            'msg2' => '', 
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 9 calcula Suma de columna xxx totales'
          ] );                                           
  
            $CN->consistencia_cantidad_x_cuadro(3); // por si hay que eliminar consistencias viejas
//
// //       // cuadro 10, MATRÍCULA ATENDIDA DE MODALIDAD ARTÍSTICA Y ED. FÍSICA
//
      $ncuadro=10;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'MATRÍCULA ATENDIDA DE MODALIDAD ARTÍSTICA Y ED. FÍSICA',
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,12,8]] ]);
      ...
      //filas 3 y 4
      $CN->def_cuadro_store(['valor_inicial'=>'ATDI', 'rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'personal propio', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'de otra escuela', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[4,2]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Nivel Inicial', 'rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[5,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'personal propio', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[5,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'de otra escuela', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[6,2]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Educación Primaria', 'rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[7,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'personal propio', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[7,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'de otra escuela', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[8,2]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Ed. Post-Primaria', 'rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[9,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'personal propio', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[9,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'de otra escuela', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[10,2]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Formación Laboral', 'rowspan'=>2, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[11,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'personal propio', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[11,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'de otra escuela', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[12,2]] ]);
    ...
    $CN->mapacuadro_store_c_mapa (121, [121],                   'especial cuadro 10') ;
    $CN->mapacuadro_store_c_mapa (122, [122,152,155,134],       'especial cuadro 10') ;
    $CN->mapacuadro_store_c_mapa (123, [123,153,156,158,134],   'especial cuadro 10') ;
    $CN->mapacuadro_store_c_mapa (131, [131,154,157,159,134],   'especial cuadro 10') ;
    $CN->mapacuadro_store_c_mapa (171, [171,134],               'especial cuadro 10') ;
    ...
    $CN->consistencia_save( [
            ...
            'cmp1' => ['v1'=> [ [[[ 3,3],[ 4,3]], [[ 3,4],[ 4,4]], [[ 3,5],[ 4,5]], [[ 3,6],[ 4,6]], [[ 3,7],[ 4,7]], [[ 3,8],[ 4,8]]], //ATDI
                                ...
                                [[[ 9,3],[10,3]], [[ 9,4],[10,4]], [[ 9,5],[10,5]], [[ 9,6],[10,6]], [[ 9,7],[10,7]], [[ 9,8],[10,8]]], //Post-Primaria
                                [[[11,3],[12,3]], [[11,4],[12,4]], [[11,5],[12,5]], [[11,6],[12,6]], [[11,7],[12,7]], [[11,8],[12,8]]]  //laboral
                              ]
                      ], 
            'cmp2' => ['v2'=>[   // celdas de otros cuadros a sumar para la comparación
                                ['cel'=>[[3,0,4]]],  //maternal
                                ['cel'=>[[4,0,2],[4,0,3],[5,0,3],[5,0,4],[7,0,2],[7,0,3]]],  //inicial
                                ['reg'=>[[4,0,4,0,7],[5,0,5,0,8],[7,0,4,0,7]]],  // primaria
                                ['reg'=>[[4,0,8,0,11],[5,0,9,0,12],[7,0,8,0,11]]], //pos-primaria
                                ['cel'=>[[6,0,4],[8,0,4]]],  //laboral
                              ]
                      ],
            'cmp3' => ['d1'=> [ [ 'ATDI / Ed. Física',
                                  'ATDI / Artística Plástica',
                                  'ATDI / Artística Danza - Exp. corporal',
                                  'ATDI / Artística Música',
                                  'ATDI / Artística Teatro',
                                  'ATDI / Artística Literatura'
                                ],
                                [ 'N. Inicial / Ed. Física',
                                  'N. Inicial / Artística Plástica',
                                  'N. Inicial / Artística Danza - Exp. corporal',
                                  'N. Inicial / Artística Música',
                                  'N. Inicial / Artística Teatro',
                                  'N. Inicial / Artística Literatura'
                                ],
                                [ 'Ed. Primaria / Ed. Física',
                                  'Ed. Primaria / Artística Plástica',
                                  'Ed. Primaria / Artística Danza - Exp. corporal',
                                  'Ed. Primaria / Artística Música',
                                  'Ed. Primaria / Artística Teatro',
                                  'Ed. Primaria / Artística Literatura'
                                ],
                                [ 'Ed. Post-Primaria / Ed. Física',
                                  'Ed. Post-Primaria / Artística Plástica',
                                  'Ed. Post-Primaria / Artística Danza - Exp. corporal',
                                  'Ed. Post-Primaria / Artística Música',
                                  'Ed. Post-Primaria / Artística Teatro',
                                  'Ed. Post-Primaria / Artística Literatura'
                                ],
                                [ 'F. Laboral / Ed. Física',
                                  'F. Laboral / Artística Plástica',
                                  'F. Laboral / Artística Danza - Exp. corporal',
                                  'F. Laboral / Artística Música',
                                  'F. Laboral / Artística Teatro',
                                  'F. Laboral / Artística Literatura'
                                ]
                            ],
                      
                       'd2'=> [ ['3','3','3','3','3','3'],
                                ['4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7'],
                                ['4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7'],
                                ['4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7','4, 5 y 7'],
                                ['6 y 8 ','6 y 8','6 y 8','6 y 8','6 y 8','6 y 8'],
                              ]
                      ],
            'msg1' => 'Los alumnos de ',
            'msg2' => 'superan los informados en cuadro ',
...
//
// //       // cuadro 11, ESPECIAL - EGRESADOS QUE FINALIZAN LA ETAPA EN EL NIVEL INICIAL (ATDI) 0 A 3 AÑOS.
//
      $ncuadro=11;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'EGRESADOS QUE FINALIZAN LA ETAPA EN EL NIVEL INICIAL (ATDI) 0 A 3 AÑOS.',
                                              'descripcion'=>'matrícula estimulación temprana',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>2 , // PUEDE NO TENER DATOS
                                              'filas'=>5,
      ...
      $CN->mapacuadro_store_c_mapa (121, [121], 'especial cuadro 11') ;
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 11, Suma de columna xxx <> Total'
          ] );             
      ...
      $CN->consistencia_save( 
          [
            ...
            'cmp2' => ['scol'=>[[2,3]]] ,
            'cmp3' => [], 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial-cuadro 11 calcula Suma de columna xxx totales'
          ] ); 
/*
      $CN->consistencia_save( 
          [
            ...
            'c_estado' =>  1, // Consistencia activa
                                // celdas a comparar del cuadro
            'cmp1' => [ 'v1'=>  [ [[[5,2]]], // ATDI Varón
                                  [[[5,3]]], // ATDI Mujer
                                ]
                      ], 
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  [ 'cel'=>[[3,0,2]]],  // MAT. ATDI Varón
                                  [ 'cel'=>[[3,0,3]]],  // MAT. ATDI Mujer
                                ]
            //    'sig'=>'>',
                      ],
            'cmp3' => [ 'd1'=>  [ [ 'N. Inicial (ATDI) - Varón'],
                                  [ 'N. Inicial (ATDI) - Mujer'],
                                ],
                        'd2'=>  [ ['3', '3'],
                                ],
                      ],
            'msg1' => 'Los egresados de ',
            'msg2' => 'superan los alumnos matriculados del cuadro ',
            'msg3' => '',    
...
*/
      ...
      $CN->consistencia_save( 
          [
            ...
            'c_categoria_consistencia' =>  3, // Consistencia de Error
            'c_estado' =>  1, // Consistencia activa
            'cmp1' => [ 'cols'=> [[2,2],[3,3]], // columnas a comparar si no se envia se comparan todas las columnas (opcional)
                        //'fils'=> [[3,3],[4,4]], // columnas a comparar si no se envia se comparan todas las columnas (opcional)
                      ], 
            'cmp2' => [ 'cuadro' =>3, // numero de cuadro con el que se compara
                        'cmp' =>'>', // tipo de comparación
                      ],
            'cmp3' => [ 'tcol' =>[2], // filas con texto para el mesaje 
                        'tfil' =>[1], // columnas con texto para el mensaje
                        //'textc' =>['',''], // texto de las columnas (opcional) para el mensaje
...
//
// //       // cuadro 12, ESPECIAL - EGRESADOS DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)
//
      $ncuadro=12;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'EGRESADOS DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)',
                                              'descripcion'=>'EGRESADOS DE LOS NIVELES (EN SEDE)',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>2 , // PUEDE NO TENER DATOS
                                              'filas'=>10,
                                              'ancho'=>925,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null','c_mapa'=>null ],  ['region'=> [ [1,1,10,10]] ]);

      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Clase','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Nivel Inicial', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Primaria', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Post-Primaria', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'rowspan'=>1,'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,8]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Retardo Mental', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[7,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Trastornos en el Desarrollo del Lenguaje y la Comunic.', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[8,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Multimpedidos', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[9,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>122] , ['region'=> [ [3,2,10,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>123] , ['region'=> [ [3,4,10,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>131] , ['region'=> [ [3,6,10,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>1122] , ['region'=> [ [3,8,10,10]] ]);


      $CN->def_cuadro_save() ;

            // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 122, [122],'especial cuadro 12') ;
      $CN->mapacuadro_store_c_mapa ( 123, [123],'especial cuadro 12') ;
      $CN->mapacuadro_store_c_mapa ( 131, [131],'especial cuadro 12') ;
      $CN->mapacuadro_store_c_mapa (1122, [122,123,131],'especial cuadro 12') ;
      ...
      //           'msg2' => '',
      //           'msg3' => '',    
      //           'descripcion' => 'especial-cuadro 12, ingresar datos no 0 or on'
      //           ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp3' => ['tit' => [   '2' => 'Nivel Inicial / Varón ',
                                    ...
                                    '4' => 'Ed. Primaria / Varón ',
                                    '5' => 'Ed. Primaria / Mujer ',
                                    '6' => 'Ed. Post-Primaria / Varón ',
                                    '7' => 'Ed. Post-Primaria / Mujer ',
                                    '8' =>  'Total / Varón ',
                                    '9' => 'Total / Mujer ',
                                    '10' => 'Total '
                                ]
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 12, Suma de columna xxx <> Total'
          ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp2' => ['scol' => [[2,4,6],[3,5,7],[8,9] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 12, Total  varon x fila <> suma de varónes'
          ] );
/*
      $CN->consistencia_save(
          [
            ...
            'c_estado' =>  1, // Consistencia activa
                                // celdas a comparar del cuadro
            'cmp1' => [ 'v1'=>  [ [[[10,2]]], // inicial Varon
                                  [[[10,3]]], // inicial Mujer
                                  [[[10,4]]], // primaria Varón
                                  [[[10,5]]], // primaria Mujer
                                  [[[10,6]]], // Post-Primaria Varon
                                  [[[10,7]]], // Post-Primaria Mujer                             
                                ],
                      ], 
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  ['cel'=>[[4,0,2]]],  //inicial Varón
                                  ['cel'=>[[4,0,3]]],  //inicial Mujer
                                  ['cel'=>[[4,0,6]]],  //primaria Varón
                                  ['cel'=>[[4,0,7]]],  //primaria Mujer
                                  ['cel'=>[[4,0,10]]],  //pos-primaria Varón
                                  ['cel'=>[[4,0,11]]],  //pos-primaria Mujer
                                ],
                    //    'sig'=>'>',
                      ],
            'cmp3' => [ 'd1'=>  [ [ 'N. Inicial - Varón' ], ['N. Inicial - Mujer' ],
                                  [ 'Ed. Primaria - Varón' ],  [ 'Ed. Primaria - Mujer' ],
                                  [ 'Ed. Post-Primaria - Varón' ], [ 'Ed. Post-Primaria - Mujer' ],                                       
                                ],
                        'd2'=>  [ ['4'], ['4'],
                                  ['4'], ['4'],
                                  ['4'], ['4'],
            ...
            'msg2' => 'superan los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 12, control de egresados<=matricula'
          ] );
...
*/
          $CN->consistencia_save( 
            [
              ...
              'c_categoria_consistencia' =>  3, // Consistencia de Error
              'c_estado' =>  1, // Consistencia activa
              'cmp1' => [ 'cols'=> [[2,2],[3,3],[4,6],[5,7],[6,10],[7,11] ], // columnas a comparar;  si no se envia se comparan todas las columnas
                          'fils'=> [[3,4],[4,5],[5,6],[6,7],[7,8],[8,9],[9,10] ], // filas a comparar; si no se envia se comparan todas las columnas (opcional)
                        ], 
              'cmp2' => [ 'cuadro' =>4, // numero de cuadro con el que se compara
                          'cmp' =>'>', // tipo de comparación
                        ],
              'cmp3' => [ 'tcol' =>[2], // filas con texto para el mesaje 
                          'tfil' =>[1], // columnas con texto para el mensaje
                          'textc' =>[ 'N. Inicial','N. Inicial',   // texto de las columnas (opcional) para el mensaje
                                      'Ed. Primaria','Ed. Primaria',
                                      'Ed. Post-Primaria','Ed. Post-Primaria'
                                    ], 
                          //'textf' =>['',''], // texto de las filas (opcional) para el mensaje'
                        ],
                        // estructura del mensage =  msg1 . tfil .'-'. tcol .v1. msg2 . v2
              'msg1' => 'Los egresados de ',  
              'msg2' => 'superan los alumnos matriculados del cuadro 4',
              'msg3' => '',    
              'descripcion' => 'especial-cuadro 12, control de egresados<=matricula'
            ] );
...
//
// //       // cuadro 13, ESPECIAL - EGRESADOS, DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO,
//                                    //, DOMICILIARIOS Y HOSPITALARIOS
//
      $ncuadro=13;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'EGRESADOS, DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO, DOMICILIARIOS Y HOSPITALARIOS',
                                              'descripcion'=>'EGRESADOS DOMICILIARIOS Y HOSPITALARIOS X NIVEL',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>2 , // PUEDE NO TENER DATOS
                                              'filas'=>7,
                                              'ancho'=>900,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false ,'c_mapa'=>null, 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,7,11]] ]);


      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Clase','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Condición','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Nivel Inicial', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Primaria', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Post-Primaria', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'rowspan'=>1,'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,9]] ]);
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>155] , ['region'=> [ [3,3,7,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>156] , ['region'=> [ [3,5,7,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>157] , ['region'=> [ [3,7,7,8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>1155] , ['region'=> [ [3,9,7,11]] ]);

      $CN->def_cuadro_save() ;


      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 155, [152,155],    'especial cuadro 13') ;
      $CN->mapacuadro_store_c_mapa ( 156, [153,156,158],'especial cuadro 13') ;
      $CN->mapacuadro_store_c_mapa ( 157, [154,157,159],'especial cuadro 13') ;
      $CN->mapacuadro_store_c_mapa (1155, [152,153,154,155,156,157,158,159],'especial cuadro 13') ;
      ...
      //           'msg2' => '',
      //           'msg3' => '',    
      //           'descripcion' => 'especial-cuadro 13, ingresar datos no 0 or on'
      //           ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp3' => ['tit' => [   '3' => 'Nivel Inicial / Varón ',
                                    ...
                                    '5' => 'Ed. Primaria / Varón ',
                                    '6' => 'Ed. Primaria / Mujer ',
                                    '7' => 'Ed. Post-Primaria / Varón ',
                                    '8' => 'Ed. Post-Primaria / Mujer ',
                                    '9' => 'Total / Varón ',
                                    '10' => 'Total / Mujer ',
                                    '11' => 'Total '
                                ]
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 13, Suma de columna xxx <> Total'
          ] );      
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp2' => ['scol' => [[3,5,7],[4,6,8],[9,10] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 13, Total  varon x fila <> suma de varónes'
          ] );                
/*
      $CN->consistencia_save( 
          [
            ...
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  ['cel'=>[[5,0,3]]],  //inicial V
                                  ['cel'=>[[5,0,4]]],  //inicial M
                                  ['cel'=>[[5,0,7]]],  //primaria  2°c V
                                  ['cel'=>[[5,0,8]]],  //primaria  2°c M
                                  ['cel'=>[[5,0,11]]],  //Post-Primaria 2°c V
                                  ['cel'=>[[5,0,12]]],  //Post-Primaria 2°c M
                                ]
                    //    'sig'=>'>',
                      ],
            'cmp3' => ['d1'=> [ [ 'N. Inicial / Varón' ], [ 'N. Inicial / Mujer' ],
            ...
            'msg1' => 'Los egresados domiciliarios y hospitalarios de ',
            'msg2' => 'superan los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 13, control de egresados<=matricula'
          ] );
*/
      ...
      $CN->consistencia_save( 
            [
              ...
              'c_categoria_consistencia' =>  3, // Consistencia de Error
              'c_estado' =>  1, // Consistencia activa
              'cmp1' => [ 'cols'=> [[3,3],[4,4],[5,7],[6,8],[7,11],[8,12] ], // columnas a comparar;  si no se envia se comparan todas las columnas
                          'fils'=> [[3,4],[4,5],[5,6],[6,7] ], // filas a comparar; si no se envia se comparan todas las columnas (opcional)
                        ], 
              'cmp2' => [ 'cuadro' =>5, // numero de cuadro con el que se compara
                          'cmp' =>'>', // tipo de comparación
                        ],
              'cmp3' => [ 'tcol' =>[2], // filas con texto para el mesaje 
                          'tfil' =>[2], // columnas con texto para el mensaje
                          'textc' =>[ 'N. Inicial','N. Inicial',   // texto de las columnas (opcional) para el mensaje
                                      'Ed. Primaria','Ed. Primaria',
                                      'Ed. Post-Primaria','Ed. Post-Primaria'
                                    ], 
                          'textf' =>['Domiciliarios','Domiciliarios','Hospitalarios','Hospitalarios'], // texto de las filas (opcional) para el mensaje'
                        ],
                        // estructura del mensage =  msg1 . tfil .'-'. tcol .v1. msg2 . v2
              'msg1' => 'Los egresados de ',  
              'msg2' => 'superan los alumnos matriculados del cuadro 5',
              'msg3' => '',    
              'descripcion' => 'especial-cuadro 13, control de egresados<=matricula'
            ] );
      ...
      $CN->consistencia_cantidad_x_cuadro(3); // por si hay que eliminar consistencias viejas
//
// //       // cuadro 14, ESPECIAL - EGRESADOS DE FORMACIÓN LABORAL (EN SEDE)
//
      $ncuadro=14;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'EGRESADOS DE FORMACIÓN LABORAL (EN SEDE)',
                                              'descripcion'=>'EGRESADOS DE Formación Laboral en sede',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>2 , // PUEDE NO TENER DATOS
                                              'filas'=>3,
                                              'ancho'=>460,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false ,'c_mapa'=>null, 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,3,4]] ]);
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>171] , ['region'=> [ [3,2,3,4]] ]);

      $CN->def_cuadro_save() ;

      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 171, [171], 'especial cuadro 14') ;
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg2' => 'es distinto de suma de varones y mujeres ',
            'msg3' => '',    
            'descripcion' => 'especial -cuadro 14, Total x fila <> suma de varón + mujer'
          ] );
/*
      $CN->consistencia_save( 
          [
            ...
            'c_estado' =>  1, // Consistencia activa
                                // celdas a comparar del cuadro
            'cmp1' => [ 'v1'=>  [ [[[3,2]]], // Formacion laboral Varón en sede 
                                  [[[3,3]]], // Formacion laboral Mujer en sede 
                                ]
                      ], 
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  ['cel'=>[[6,0,2]]],  // mat. form. laboral Varón
                                  ['cel'=>[[6,0,3]]],  // mat. form. laboral Mujer
                                ]
                    //    'sig'=>'>',
                      ],
            'cmp3' => [ 'd1'=>  [ [ 'Formación Laboral / Varón ' ], [ 'Formación Laboral / Mujer' ],
                                ],
                        'd2'=>  [ ['6'],['6'],
                                ]
                      ],
            ...
            'msg2' => 'superan los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 14, control de egresados<=matricula'
          ] );
*/
          ...
          $CN->consistencia_save( 
            [
              ...
              'cmp2' => [ 'cuadro' =>6, // numero de cuadro con el que se compara
                          'cmp' =>'>', // tipo de comparación
                        ],
              'cmp3' => [ //'tcol' =>[3], // filas con texto para el mesaje 
                          //'tfil' =>[1,2], // columnas con texto para el mensaje
                          'textc' =>[    // texto de las columnas (opcional) para el mensaje
                                      '', // texto de 1er columna no semuestra es titulo
                                      'Formación Laboral / Varón ', 'Formación Laboral / Mujer' 
                                    ], 
                          //'textf' =>['',''], // texto de las filas (opcional) para el mensaje'
                        ],
                        // estructura del mensage =  msg1 . tfil .'-'. tcol .v1. msg2 . v2
...
//
// //       // cuadro 15, ESPECIAL - EGRESADOS DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)
//
      $ncuadro=15;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'EGRESADOS DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)',
                                              'descripcion'=>'matrícula de niveles en EN INTEGRACIÓN)',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // debe TENER DATOS
                                              'filas'=>10,
                                              'ancho'=>1105,
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [3,2,10,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [3,4,10,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [3,6,10,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>134] , ['region'=> [ [3,8,10,10]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 134, [134], 'especial cuadro 15') ;
      ...
      //           'msg2' => '',
      //           'msg3' => '',    
      //           'descripcion' => 'especial-cuadro 15, ingresar datos no 0 or on'
      //           ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 15, Suma de columna xxx <> Total'
          ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'cmp2' => ['scol' => [[2,4,6],[3,5,7],[8,9] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 15 , Total  varon x fila <> suma de varónes'
          ] );
/*
      $CN->consistencia_save( 
          [
            ...
            'c_estado' =>  1, // Consistencia activa
                                // celdas a comparar del cuadro
            'cmp1' => ['v1'=> [ [[[10,2]]], // inicial V
                                [[[10,3]]], // inicial M
                                [[[10,4]]], // primaria V
                                [[[10,5]]], // primaria M
                                [[[10,6]]], // Post-Primaria V
                                [[[10,7]]], // Post-Primaria M                                    
                              ]
                      ], 
            'cmp2' => ['v2'=> [   // celdas de otros cuadros a sumar para la comparación
                                ['cel'=>[[7,0,2]]],  //inicial V
                                ['cel'=>[[7,0,3]]],  //inicial M
                                ['cel'=>[[7,0,6]]],  //primaria  2°c V
                                ['cel'=>[[7,0,7]]],  //primaria  2°c M
                                ['cel'=>[[7,0,10]]],  //Post-Primaria 2°c V
                                ['cel'=>[[7,0,11]]],  //Post-Primaria 2°c M   
                              ]
                        // 'sig'=>'>',
                      ],
            'cmp3' => [ 'd1'=>  [ [ 'N. Inicial / Varón' ], [ 'N. Inicial / Mujer' ],
            ...
            'msg1' => 'Los egresados en integración de ',
            'msg2' => 'superan los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 15, control de egresados<=matricula'
          ] );
*/    
      $CN->consistencia_save( 
            [
              ...
              'cmp2' => [ 'cuadro' =>7, // numero de cuadro con el que se compara
                          'cmp' =>'>', // tipo de comparación
                        ],
              'cmp3' => [ 'tcol' =>[2], // filas con texto para el mesaje 
                          'tfil' =>[1], // columnas con texto para el mensaje
                        ...
                        // estructura del mensage =  msg1 . tfil .'-'. tcol .v1. msg2 . v2
              'msg1' => 'Los egresados de ',  
              'msg2' => 'superan los alumnos matriculados del cuadro Nº7',
              'msg3' => '',    
              'descripcion' => 'especial-cuadro 15, control de egresados<=matricula'
            ] );
...
//      
// //       // cuadro 16, ESPECIAL - EGRESADOS DE FORMACIÓN LABORAL (EN INTEGRACIÓN)
//
      $ncuadro=16;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'EGRESADOS DE FORMACIÓN LABORAL (EN INTEGRACIÓN)',
                                              'descripcion'=>'EGRESADOS DE FORMACIÓN LABORAL (EN INTEGRACIÓN)',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // debe TENER DATOS
                                              'filas'=>3,
                                              'ancho'=>460,
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [3,2,3,4]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 134, [134], 'especial cuadro 16') ;
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg2' => 'es distinto de suma de varones y mujeres ',
            'msg3' => '',    
            'descripcion' => 'especial -cuadro 16, Total x fila <> suma de varón + mujer'
          ] );
 /*
      $CN->consistencia_save( 
          [
            ...
            'c_estado' =>  1, // Consistencia activa
                                // celdas a comparar del cuadro
            'cmp1' => ['v1'=> [ [[[3,2]]], // Formacion laboral en sede M
                                [[[3,3]]], // Formacion laboral en sede V
                              ]
                      ], 
            'cmp2' => ['v2'=> [   // celdas de otros cuadros a sumar para la comparación
                                ['cel'=>[[8,0,2]]],  // mat. form. laboral V
                                ['cel'=>[[8,0,3]]],  // mat. form. laboral M
                              ]
                    //    'sig'=>'>',
                      ],
            'cmp3' => [ 'd1'=>  [ [ 'Varón' ], [ 'Mujer' ],
            ...
            'msg1' => 'Los egresados en integración de Formación Laboral / ',
            'msg2' => 'superan los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 14, control de egresados<=matricula'
          ] );
...
*/
          $CN->consistencia_save( 
            [
              ...
              'cmp2' => [ 'cuadro' =>8, // numero de cuadro con el que se compara
                          'cmp' =>'>', // tipo de comparación
                        ],
              'cmp3' => [ //'tcol' =>[3], // filas con texto para el mesaje 
                          //'tfil' =>[1,2], // columnas con texto para el mensaje
                        ...
                        // estructura del mensage =  msg1 . tfil .'-'. tcol .v1. msg2 . v2
              'msg1' => 'Los egresados de ',  
              'msg2' => 'superan los alumnos matriculados del cuadro 8',
              'msg3' => '',    
              'descripcion' => 'especial-cuadro 16, control de egresados<=matricula'
            ] );

      $CN->consistencia_cantidad_x_cuadro(2); // por si hay que eliminar consistencias viejas

//
// //       // cuadro 17, ESPECIAL - RESULTADO DE LA ENSEÑANZA DE NIVEL INICIAL (ATDI) 0 A 3 AÑOS.
//
      $ncuadro=17;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'RESULTADO DE LA ENSEÑANZA DE NIVEL INICIAL (ATDI) 0 A 3 AÑOS.',
                                              'descripcion'=>'RESULTADO DE LA ENSEÑANZA DE NIVEL INICIAL (ATDI) 0 A 3 AÑOS.',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                                              'filas'=>5,
                                              'ancho'=>335,
      ...
      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Etapa / Resultado','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Alumnos', 'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,4]] ]);
      //filas 3 y 4
      $CN->def_cuadro_store(['valor_inicial'=>'Continúa en la etapa', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Finaliza', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total Matrícula Final', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[5,1]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 121, [121],'especial cuadro 18') ;
      ...
      //                               'numero' => 1,
      //                               [ 'id_consistencia' => 96,
      //                               'id_definicion_formulario' => $F->id_definicion_formulario, // nulo no permitido daria error
      //                               'id_definicion_cuadro' => $CN->id_definicion_cuadro,
      //                               'id_definicion_celda' => null,
      //                               'c_tipo_consistencia' => 10, // con datos no 0 or on
      //                               'c_categoria_consistencia' =>  3, // Consistencia de Error
      //                               'c_estado' =>  1, // Consistencia activa
      //                               'numero' =>  1, 
      ...
      //                               'msg2' => '',
      //                               'msg3' => '',    
      //                               'descripcion' => 'especial-cuadro 17, ingresar datos no 0 or on'
      //                               ] );
      ...
      $CN->consistencia_save(
            [
              ...
              'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
              'msg3' => '',    
              'descripcion' => 'especial-cuadro 17, Suma de columna xxx <> Total'
            ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp2' => ['scol' => [[2,3] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 17, Total  varon x fila <> suma de varónes'
          ] );                      
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg1' => 'La matrícula final del resultado de la enseñanza del ',
            'msg2' => 'difiere de los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 17, control de resultado!=matricula'
          ] );
...
//
// //       // cuadro 18, ESPECIAL - RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)
//
      $ncuadro=18;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)',
                                              'descripcion'=>'RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN SEDE)',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                                              'filas'=>6,
                                              'ancho'=>1038,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,6,14]] ]);

      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Etapa / Resultado','rowspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Nivel Inicial', 'rowspan'=>2,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Post-Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,8]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'rowspan'=>2,'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,12]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Continúa en el ciclo', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Promueve al ciclo/nivel siguiente', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[5,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total Matrícula Final', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[6,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>122] , ['region'=> [ [4,2,6,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>123] , ['region'=> [ [4,4,6,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>131] , ['region'=> [ [4,8,6,11]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>1122] , ['region'=> [ [4,12,6,14]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 122, [122],'especial cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 123, [123],'especial cuadro 18') ;
      $CN->mapacuadro_store_c_mapa ( 131, [131],'especial cuadro 18') ;
      $CN->mapacuadro_store_c_mapa (1122, [122,123,131],'especial cuadro 18') ;
      ...
      //           'msg2' => '',
      //           'msg3' => '',    
      //           'descripcion' => 'especial-cuadro 18, ingresar datos no 0 or on'
      //           ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 18, Suma de columna xxx <> Total'
          ] ); 
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp2' => ['scol' => [[2,4,6,8,10],[3,5,7,9,11],[12,13] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 18, Total  varon x fila <> suma de varónes'
          ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp1' => [ 'v1'=>  [               
                                  [[[6,2]]], // inicial Varón
                                  [[[6,3]]], // inicial Mujer
                                  [[[6,4]]], // primaria 1°c Varón
                                  [[[6,5]]], // primaria 1°c Mujer
                                  [[[6,6]]], // primaria 2°c Varón
                                  [[[6,7]]], // primaria 2°c Mujer
                                  [[[6,8]]], // Post-Primaria 1°c Varón                                     
                                  [[[6,9]]], // Post-Primaria 1°c Mujer                                     
                                  [[[6,10]]], // Post-Primaria 2°c Varón                                     
                                  [[[6,11]]], // Post-Primaria 2°c Mujer                                  
                                ],
                      ], 
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  [ 'cel'=>[[4,0,2]]],  // inicial Varón
                                  [ 'cel'=>[[4,0,3]]],  // inicial Mujer
                                  [ 'cel'=>[[4,0,4]]],  // primaria 1°c Varón
                                  [ 'cel'=>[[4,0,5]]],  // primaria 1°c Mujer
                                  [ 'cel'=>[[4,0,6]]],  // primaria 2°c Varón
                                  [ 'cel'=>[[4,0,7]]],  // primaria 2°c Mujer
                                  [ 'cel'=>[[4,0,8]]],  // Post-Primaria 1°c Varón
                                  [ 'cel'=>[[4,0,9]]],  // Post-Primaria 1°c Mujer
                                  [ 'cel'=>[[4,0,10]]], // Post-Primaria 2°c Varón 
                                  [ 'cel'=>[[4,0,11]]], // Post-Primaria 2°c Mujer 
                                ],
                        'sig'=> '!=',
                      ],
            'cmp3' => [ 'd1'=>  [ 
                                  [ 'N. Inicial - Varón' ],[ 'N. Inicial - Mujer' ],
                                  [ 'Ed. Primaria - 1° Ciclo Varón' ],[ 'Ed. Primaria - 1° Ciclo Mujer' ],
                                  [ 'Ed. Primaria - 2° Ciclo Varón' ],[ 'Ed. Primaria - 2° Ciclo Mujer' ],
                                  [ 'Ed. Post-Primaria - 1° Ciclo Varón' ],[ 'Ed. Post-Primaria - 1° Ciclo Mujer' ],
                                  [ 'Ed. Post-Primaria - 2° Ciclo Varón' ],[ 'Ed. Post-Primaria - 2° Ciclo Mujer' ],                                  
                                ],
                        'd2'=>  [ ['4'], ['4'],
                                  ['4'], ['4'], ['4'], ['4'],
                                  ['4'], ['4'], ['4'], ['4'],
            ...
            'msg1' => 'La matrícula final del resultado de la enseñanza en sede de ',
            'msg2' => 'difieren de los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 18, control de resultado!=matricula'
          ] );                
...
//      
// //       // cuadro 19, ESPECIAL - RESULTADO DE LA ENSEÑANZA, DE DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO
//                                    //, DOMICILIARIOS Y HOSPITALARIOS
//
      $ncuadro=19;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'RESULTADO DE LA ENSEÑANZA, DE DISMINUIDOS FÍSICOS IMPEDIDOS DE CONCURRIR AL SERVICIO ORDINARIO, DOMICILIARIOS Y HOSPITALARIOS',
                                              'descripcion'=>'RESULTADO DE DOMICILIARIOS Y HOSPITALARIOS',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                                              'filas'=>16,
                                              'ancho'=>1066,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,16,16]] ]);

      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Clase','rowspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Condición','rowspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Resultado','rowspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,3]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Nivel Inicial', 'rowspan'=>2,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,4]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,6]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Educación Post-Primaria', 'rowspan'=>1,'colspan'=>4,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,10]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'rowspan'=>2,'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,14]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'1° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,10]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'2° Ciclo', 'rowspan'=>1,'colspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,12]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Impedidos de concurrir al Servicio Ordinario (Domiciliarios)', 'rowspan'=>6, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[4,1]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Permanente','rowspan'=>3, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[4,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Continúa en el ciclo', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[4,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Promueve al ciclo/nivel siguiente', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[5,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Desaprobados', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[6,3]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Transitorio','rowspan'=>3, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[7,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Continúa en el ciclo', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[7,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Promueve al ciclo/nivel siguiente', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Impedidos de concurrir al Servicio Ordinario (Hospitalarios)', 'rowspan'=>6, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[10,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Permanente','rowspan'=>3, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[10,2]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Continúa en el ciclo', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Total de Matrícula Final', 'colspan'=>3, 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'],
                    ['celdas'=> [[16,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>155] , ['region'=> [ [4,4,16,5]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>156] , ['region'=> [ [4,6,16,9]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>157] , ['region'=> [ [4,10,16,13]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>1155] , ['region'=> [ [4,14,16,16]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 155, [152,155],    'especial cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 156, [153,156,158],'especial cuadro 19') ;
      $CN->mapacuadro_store_c_mapa ( 157, [154,157,159],'especial cuadro 19') ;
      $CN->mapacuadro_store_c_mapa (1155, [152,153,154,155,156,157,158,159],'especial cuadro 19') ;
      ...
      //           'msg2' => '',
      //           'msg3' => '',    
      //           'descripcion' => 'especial-cuadro 19, ingresar datos no 0 or on'
      //           ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp1' => [] ,
            'cmp2' => [] ,
            'cmp3' => ['tit' => [   '4' => 'Nivel Inicial / Varón ',
                                    '5' => 'Nivel Inicial / Mujer ',
                                    '6' => 'Ed. Primaria / 1° Ciclo / Varón ',
                                    '7' => 'Ed. Primaria / 1° Ciclo / Mujer ',
                                    '8' => 'Ed. Primaria / 2° Ciclo / Varón ',
                                    '9' => 'Ed. Primaria / 2° Ciclo / Mujer ',
                                    '10' => 'Ed. Post-Primaria / 1° Ciclo / Varón ',
                                    '11' => 'Ed. Post-Primaria / 1° Ciclo / Mujer ',
                                    '12' => 'Ed. Post-Primaria / 2° Ciclo / Varón ',
                                    '13' => 'Ed. Post-Primaria / 2° Ciclo / Mujer ',
                                    '14' =>  'Total / Varón ',
                                    '15' => 'Total / Mujer ',
                                    '16' => 'Total '
                                ]
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 19, Suma de columna xxx <> Total'
          ] );                      
      ...
      $CN->consistencia_save(
          [
            ...
            'c_estado' =>  1, // Consistencia activa
            'cmp1' => ['col' => [14,15,16] ] ,
            'cmp2' => ['scol' => [[4,6,8,10,12],[5,7,9,11,13], [14,15] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 19, Total  varon x fila <> suma de varónes'
          ] );                      
          ...
          $CN->consistencia_save( 
            [
              ...
              'c_estado' =>  1, // Consistencia activa
                                  // celdas a comparar del cuadro
              'cmp1' => [ 'v1'=>  [ [[[ 4,4],[ 5,4],[ 6,4]]], // dom / per / ini / V
                                    [[[ 7,4],[ 8,4],[ 9,4]]], // dom / tra / ini / V
                                    [[[10,4],[11,4],[12,4]]], // hos / per / ini / V
                                    [[[13,4],[14,4],[15,4]]], // hos / tra / ini / V
  
                                    [[[ 4,5],[ 5,5],[ 6,5]]], // dom / per / ini / M
                                    [[[ 7,5],[ 8,5],[ 9,5]]], // dom / tra / ini / M
                                    [[[10,5],[11,5],[12,5]]], // hos / per / ini / M
                                    [[[13,5],[14,5],[15,5]]], // hos / tra / ini / M
                                    
                                    [[[ 4,6],[ 5,6],[ 6,6]]], // dom / per / pri 1c / V
                                    [[[ 7,6],[ 8,6],[ 9,6]]], // dom / tra / pri 1c / V
                                    [[[10,6],[11,6],[12,6]]], // hos / per / pri 1c / V
                                    [[[13,6],[14,6],[15,6]]], // hos / tra / pri 1c / V
  
                                    [[[ 4,7],[ 5,7],[ 6,7]]], // dom / per / pri 1c / M
                                    [[[ 7,7],[ 8,7],[ 9,7]]], // dom / tra / pri 1c / M
                                    [[[10,7],[11,7],[12,7]]], // hos / per / pri 1c / M
                                    [[[13,7],[14,7],[15,7]]], // hos / tra / pri 1c / M
  
                                    [[[ 4,8],[ 5,8],[ 6,8]]], // dom / per / pri 2c / V
                                    [[[ 7,8],[ 8,8],[ 9,8]]], // dom / tra / pri 2c / V
                                    [[[10,8],[11,8],[12,8]]], // hos / per / pri 2c / V
                                    [[[13,8],[14,8],[15,8]]], // hos / tra / pri 2c / V
  
                                    ]
                        ], 
              'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                    [ 'cel'=>[[5,4,3]]],  // dom / per / ini / V
                                    [ 'cel'=>[[5,5,3]]],  // dom / tra / ini / V
                                    [ 'cel'=>[[5,6,3]]],  // hos / per / ini / V
                                    [ 'cel'=>[[5,7,3]]],  // hos / tra / ini / V
  
                                    [ 'cel'=>[[5,4,4]]],  // dom / per / ini / m
                                    [ 'cel'=>[[5,5,4]]],  // dom / tra / ini / m
                                    [ 'cel'=>[[5,6,4]]],  // hos / per / ini / m
                                    [ 'cel'=>[[5,7,4]]],  // hos / tra / ini / m                                  
  
                                    [ 'cel'=>[[5,4,5]]],  // dom / per / pri 1c / V
                                    [ 'cel'=>[[5,5,5]]],  // dom / tra / pri 1c / V
                                    [ 'cel'=>[[5,6,5]]],  // hos / per / pri 1c / V
                                    [ 'cel'=>[[5,7,5]]],  // hos / tra / pri 1c / V
  
                                    [ 'cel'=>[[5,4,6]]],  // dom / per / pri 1c / m
                                    [ 'cel'=>[[5,5,6]]],  // dom / tra / pri 1c / m
                                    [ 'cel'=>[[5,6,6]]],  // hos / per / pri 1c / m
                                    [ 'cel'=>[[5,7,6]]],  // hos / tra / pri 1c / m
                                    
                                    [ 'cel'=>[[5,4,7]]],  // dom / per / pri 2c / V
                                    [ 'cel'=>[[5,5,7]]],  // dom / tra / pri 2c / V
                                    [ 'cel'=>[[5,6,7]]],  // hos / per / pri 2c / V
                                    [ 'cel'=>[[5,7,7]]],  // hos / tra / pri 2c / V
                                
                                  ],  
                          'sig'=> '!=',
                        ],
              'cmp3' => [ 'd1'=>  [ [ 'N. Inicial - domiciliario - permanente  - Varón' ],
                                    [ 'N. Inicial - domiciliario - transitorio - Varón' ],
                                    [ 'N. Inicial - hospitalario - permanente  - Varón' ],
                                    [ 'N. Inicial - hospitalario - transitorio - Varón' ],
  
                                    [ 'N. Inicial - domiciliario - permanente  - Mujer' ],
                                    [ 'N. Inicial - domiciliario - transitorio - Mujer' ],
                                    [ 'N. Inicial - hospitalario - permanente  - Mujer' ],
                                    [ 'N. Inicial - hospitalario - transitorio - Mujer' ],
  
                                    [ 'N. Primario 1°ciclo - domiciliario - permanente  - Varón' ],
                                    [ 'N. Primario 1°ciclo - domiciliario - transitorio - Varón' ],
                                    [ 'N. Primario 1°ciclo - hospitalario - permanente  - Varón' ],
                                    [ 'N. Primario 1°ciclo - hospitalario - transitorio - Varón' ],
  
                                    [ 'N. Primario 1°ciclo - domiciliario - permanente  - Mujer' ],
                                    [ 'N. Primario 1°ciclo - domiciliario - transitorio - Mujer' ],
                                    [ 'N. Primario 1°ciclo - hospitalario - permanente  - Mujer' ],
                                    [ 'N. Primario 1°ciclo - hospitalario - transitorio - Mujer' ],
  
                                    [ 'N. Primario 2°ciclo - domiciliario - permanente  - Varón' ],
                                    [ 'N. Primario 2°ciclo - domiciliario - transitorio - Varón' ],
                                    [ 'N. Primario 2°ciclo - hospitalario - permanente  - Varón' ],
                                    [ 'N. Primario 2°ciclo - hospitalario - transitorio - Varón' ],
              ...
              'msg1' => 'El total de alumnos según resultado de la enseñanza de ',
              'msg2' => 'difiere de la matrícula final del cuadro ',
              'msg3' => '',    
              'descripcion' => 'especial-cuadro 19, control de resultado!=matricula'
            ] );
      ...
      $CN->consistencia_save( 
            [
              ...
              'c_estado' =>  1, // Consistencia activa
                                  // celdas a comparar del cuadro
              'cmp1' => [ 'v1'=>  [ 
                                    [[[ 4,9],[ 5,9],[ 6,9]]], // dom / per / pri 2c / M
                                    [[[ 7,9],[ 8,9],[ 9,9]]], // dom / tra / pri 2c / M
                                    [[[10,9],[11,9],[12,9]]], // hos / per / pri 2c / M
                                    [[[13,9],[14,9],[15,9]]], // hos / tra / pri 2c / M
  
                                    [[[ 4,10],[ 5,10],[ 6,10]]], // dom / per / sec 1c / V
                                    [[[ 7,10],[ 8,10],[ 9,10]]], // dom / tra / sec 1c / V
                                    [[[10,10],[11,10],[12,10]]], // hos / per / sec 1c / V
                                    [[[13,10],[14,10],[15,10]]], // hos / tra / sec 1c / V
  
                                    [[[ 4,11],[ 5,11],[ 6,11]]], // dom / per / sec 1c / M
                                    [[[ 7,11],[ 8,11],[ 9,11]]], // dom / tra / sec 1c / M
                                    [[[10,11],[11,11],[12,11]]], // hos / per / sec 1c / M
                                    [[[13,11],[14,11],[15,11]]], // hos / tra / sec 1c / M
  
                                    [[[ 4,12],[ 5,12],[ 6,12]]], // dom / per / sec 2c / V
                                    [[[ 7,12],[ 8,12],[ 9,12]]], // dom / tra / sec 2c / V
                                    [[[10,12],[11,12],[12,12]]], // hos / per / sec 2c / V
                                    [[[13,12],[14,12],[15,12]]], // hos / tra / sec 2c / V
  
                                    [[[ 4,13],[ 5,13],[ 6,13]]], // dom / per / sec 2c / M
                                    [[[ 7,13],[ 8,13],[ 9,13]]], // dom / tra / sec 2c / M
                                    [[[10,13],[11,13],[12,13]]], // hos / per / sec 2c / M
                                    [[[13,13],[14,13],[15,13]]], // hos / tra / sec 2c / M
                                  ]
                        ], 
              'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                    
  
                                    [ 'cel'=>[[5,4,8]]],  // dom / per / pri 2c / m
                                    [ 'cel'=>[[5,5,8]]],  // dom / tra / pri 2c / m
                                    [ 'cel'=>[[5,6,8]]],  // hos / per / pri 2c / m
                                    [ 'cel'=>[[5,7,8]]],  // hos / tra / pri 2c / m                                      
  
                                    [ 'cel'=>[[5,4,9]]],  // dom / per / sec 1c / V
                                    [ 'cel'=>[[5,5,9]]],  // dom / tra / sec 1c / V
                                    [ 'cel'=>[[5,6,9]]],  // hos / per / sec 1c / V
                                    [ 'cel'=>[[5,7,9]]],  // hos / tra / sec 1c / V
  
                                    [ 'cel'=>[[5,4,10]]],  // dom / per / sec 1c / m
                                    [ 'cel'=>[[5,5,10]]],  // dom / tra / sec 1c / m
                                    [ 'cel'=>[[5,6,10]]],  // hos / per / sec 1c / m
                                    [ 'cel'=>[[5,7,10]]],  // hos / tra / sec 1c / m
                                    
                                    [ 'cel'=>[[5,4,11]]],  // dom / per / sec 2c / V
                                    [ 'cel'=>[[5,5,11]]],  // dom / tra / sec 2c / V
                                    [ 'cel'=>[[5,6,11]]],  // hos / per / sec 2c / V
                                    [ 'cel'=>[[5,7,11]]],  // hos / tra / sec 2c / V
  
                                    [ 'cel'=>[[5,4,12]]],  // dom / per / sec 2c / m
                                    [ 'cel'=>[[5,5,12]]],  // dom / tra / sec 2c / m
                                    [ 'cel'=>[[5,6,12]]],  // hos / per / sec 2c / m
                                    [ 'cel'=>[[5,7,12]]],  // hos / tra / sec 2c / m
                              
                                  ],  
                          'sig'=> '!=',
                        ],
              'cmp3' => [ 'd1'=>  [ 
                                    [ 'N. Primario 2°ciclo - domiciliario - permanente  - Mujer' ],
                                    [ 'N. Primario 2°ciclo - domiciliario - transitorio - Mujer' ],
                                    [ 'N. Primario 2°ciclo - hospitalario - permanente  - Mujer' ],
                                    [ 'N. Primario 2°ciclo - hospitalario - transitorio - Mujer' ],                                  
                                    ...
                                    [ 'N. Post-Primario 1°ciclo - domiciliario - permanente  - Mujer' ],
                                    [ 'N. Post-Primario 1°ciclo - domiciliario - transitorio - Mujer' ],
                                    [ 'N. Post-Primario 1°ciclo - hospitalario - permanente  - Mujer' ],
                                    [ 'N. Post-Primario 1°ciclo - hospitalario - transitorio - Mujer' ],
  
                                    [ 'N. Post-Primario 2°ciclo - domiciliario - permanente  - Varón' ],
                                    [ 'N. Post-Primario 2°ciclo - domiciliario - transitorio - Varón' ],
                                    [ 'N. Post-Primario 2°ciclo - hospitalario - permanente  - Varón' ],
                                    [ 'N. Post-Primario 2°ciclo - hospitalario - transitorio - Varón' ],
  
                                    [ 'N. Post-Primario 2°ciclo - domiciliario - permanente  - Mujer' ],
                                    [ 'N. Post-Primario 2°ciclo - domiciliario - transitorio - Mujer' ],
                                    [ 'N. Post-Primario 2°ciclo - hospitalario - permanente  - Mujer' ],
                                    [ 'N. Post-Primario 2°ciclo - hospitalario - transitorio - Mujer' ],                                  
...
//      
// //       // cuadro 20, ESPECIAL - RESULTADO E LA ENSEÑANZA DE FORMACIÓN LABORAL (EN SEDE)
//
      $ncuadro=20;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'RESULTADO DE LA ENSEÑANZA DE FORMACIÓN LABORAL (EN SEDE)',
                                              'descripcion'=>'RESULTADO DE LA ENSEÑANZA DE FORMACIÓN LABORAL (EN SEDE)',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                                              'filas'=>5,
                                              'ancho'=>330,
      ...
      // TITULOS DE FILAS
      //fila 1
      $CN->def_cuadro_store(['valor_inicial'=>'Resultado','rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Alumnos', 'colspan'=>3,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,4]] ]);
      //filas 3 y 4
      $CN->def_cuadro_store(['valor_inicial'=>'Aprobado', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Desaprobado', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Total Matrícula Final', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[5,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>171] , ['region'=> [ [3,2,5,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>171] , ['region'=> [ [3,4,5,4]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 171, [171],    'especial cuadro 20') ;
      ...
      //                               'msg2' => '',
      //                               'msg3' => '',    
      //                               'descripcion' => 'especial-cuadro 20, ingresar datos no 0 or on'
      //                               ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 20, Suma de columna xxx <> Total'
          ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'cmp2' => ['scol' => [[2,3] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 20, Total  varon x fila <> suma de varónes'
          ] );                      
      ...
      $CN->consistencia_save( 
          [
            ...
            'c_estado' =>  1, // Consistencia activa
                                // celdas a comparar del cuadro
            'cmp1' => [ 'v1'=>  [ [[[5,2]]], // Formacion laboral Varón en sede 
                                  [[[5,3]]], // Formacion laboral Mujer en sede 
                                ]
                      ], 
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  ['cel'=>[[6,0,2]]],  // mat. form. laboral V
                                  ['cel'=>[[6,0,3]]],  // mat. form. laboral M
                                ],
                        'sig'=> '!=',
                      ],
            'cmp3' => [ 'd1'=>  [ [ 'Formación Laboral en sede / Varón' ],[ 'Formación Laboral en sede / Mujer' ],
                                ],
                        'd2'=>  [ ['6'],['6'],
                                ]
                      ],
            'msg1' => 'La matrícula final del resultado de la enseñanza de ',
            'msg2' => 'difiere de los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 20, control de resultado!=matricula'
          ] );
...
//
// //       // cuadro 21, ESPECIAL - RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)
//
      $ncuadro=21;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)',
                                              'descripcion'=>'RESULTADO DE LA ENSEÑANZA DE LOS NIVELES INICIAL, PRIMARIO Y POST-PRIMARIO (EN INTEGRACIÓN)',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // tiene que TENER DATOS
                                              'filas'=>6,
                                              'ancho'=>1038,
      ...
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [4,2,6,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [4,4,6,7]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [4,8,6,11]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>134 ] , ['region'=> [ [4,12,6,14]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 134, [134], 'especial cuadro 21') ;
      ...
      //           'msg2' => '',
      //           'msg3' => '',    
      //           'descripcion' => 'especial-cuadro 21, ingresar datos no 0 or on'
      //           ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg1' => 'La suma de la columna ', //  'Total de las modalidades',
                'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
                'msg3' => '',    
                'descripcion' => 'especial-cuadro 21, Suma de columna xxx <> Total'
          ] );
      ...
      $CN->consistencia_save(
          [
            ...
            'cmp2' => ['scol' => [[2,4,6,8,10],[3,5,7,9,11],[12,13] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 21, Total  varon x fila <> suma de varónes'
          ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  [ 'cel'=>[[7,0,2]]],  // inicial Varón
                                  [ 'cel'=>[[7,0,3]]],  // inicial Mujer
                                  [ 'cel'=>[[7,0,4]]],  // primaria 1°c Varón
                                  [ 'cel'=>[[7,0,5]]],  // primaria 1°c Mujer
                                  [ 'cel'=>[[7,0,6]]],  // primaria 2°c Varón
                                  [ 'cel'=>[[7,0,7]]],  // primaria 2°c Mujer
                                  [ 'cel'=>[[7,0,8]]],  // Post-Primaria 1°c Varón
                                  [ 'cel'=>[[7,0,9]]],  // Post-Primaria 1°c Mujer
                                  [ 'cel'=>[[7,0,10]]], // Post-Primaria 2°c Varón 
                                  [ 'cel'=>[[7,0,11]]], // Post-Primaria 2°c Mujer 
            ...
            'msg1' => 'La matrícula final del resultado de la enseñanza en integración de ',
            'msg2' => 'difiere de los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 21, control de resultado!=matricula'
          ] );
...
//
// //       // cuadro 22, ESPECIAL - RESULTADO E LA ENSEÑANZA DE FORMACIÓN LABORAL (EN INTEGRACIÓN)
//
      $ncuadro=22;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'RESULTADO DE LA ENSEÑANZA DE FORMACIÓN LABORAL (EN INTEGRACIÓN)',
                                              'descripcion'=>'RESULTADO DE LA ENSEÑANZA DE FORMACIÓN LABORAL (EN INTEGRACIÓN)',
                                              'c_tipo_cuadro'=>1,
                                              'c_criterio_completitud'=>1 , // debe TENER DATOS
                                              'filas'=>6,
                                              'ancho'=>350,
      ...
      // inicializar las celdas del cuadro
      $CN->def_cuadro_store(['valor_inicial'=>'','rowspan'=>1, 'colspan'=>1,'estilos'=>'','editable'=>false, 'titulo'=>false , 'tipo_dato'=>'null' ],  ['region'=> [ [1,1,6,4]] ]);
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Total', 'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,4]] ]);
      //filas 3 y 6
      $CN->def_cuadro_store(['valor_inicial'=>'Continúa', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[3,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Promueve', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[4,1]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'Desaprobado', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[5,1]] ]);

      $CN->def_cuadro_store(['valor_inicial'=>'Total Matrícula Final', 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[6,1]] ]);


      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>134] , ['region'=> [ [3,2,6,3]] ]);
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'total_calculado','c_mapa'=>134] , ['region'=> [ [3,4,6,4]] ]);
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 134, [134], 'especial cuadro 22') ;
      ...
      //                               'msg2' => '',
      //                               'msg3' => '',    
      //                               'descripcion' => 'especial-cuadro 22, ingresar datos no 0 or on'
      //                               ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'msg2' => 'no se corresponde con el total declarado', //es distinto de suma de las modalidades.',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 22, Suma de columna xxx <> Total'
          ] );                      
      ...
      $CN->consistencia_save( 
          [
            ...
            'cmp2' => ['scol' => [[2,3] ]] ,
            'cmp3' => '', 'msg1' => '', 'msg2' => '', 'msg3' => '',    
            'descripcion' => 'especial -cuadro 22, Total  varon x fila <> suma de varónes'
          ] );
      ...
      $CN->consistencia_save( 
          [
            ...
            'c_estado' =>  1, // Consistencia activa
                                // celdas a comparar del cuadro
            'cmp1' => [ 'v1'=>  [ [[[6,2]]], // Formacion laboral en sede  V
                                  [[[6,3]]], // Formacion laboral en sede  M
                                ]
                      ], 
            'cmp2' => [ 'v2'=>  [   // celdas de otros cuadros a sumar para la comparación
                                  ['cel'=>[[8,0,2]]],  // mat. form. laboral V
                                  ['cel'=>[[8,0,3]]],  // mat. form. laboralM
                                ],
                        'sig'=> '!=',
                      ],
            'cmp3' => [ 'd1'=>  [ [ 'Varón' ],[ 'Mujer' ],
            ...
            'msg1' => 'La matrícula final del resultado de la enseñanza en integración de Formación Laboral / ',
            'msg2' => 'difiere de los alumnos matriculados del cuadro ',
            'msg3' => '',    
            'descripcion' => 'especial-cuadro 22, control de resultado!=matricula'
          ] );
      ...
      //
      // // cuadro 23 ESPECIAL, NOMENCLATURA CATASTRAL
      //
      $ncuadro=23;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
static public function F2018_ARTISTICA($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - EDUCACIÓN ARTÍSTICA';
      $F->nombre_corto='ED. ARTÍSTICA';
      $F->descripcion='Planilla Relevamiento Final 2018 de Artistica';
      $F->id_periodo='82';
      $F->color='f_marron';
...
//
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'4', 'editable'=>true,'tipo_dato'=>'combobox'] ,  ['celdas'=> [[4,1]] ]);
...
//       
      ...
      //
      // // cuadro 10 ARTISTICA, NOMENCLATURA CATASTRAL
      //
      $ncuadro=10;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
static public function F2018_FP($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - FORMACION PROFESIONAL';
      $F->nombre_corto='FORMACION PROFESIONAL';
      $F->descripcion='Planilla Relevamiento Final 2018 de Formación Profesional';
      $F->id_periodo='82';
      $F->color='f_naranja';
...
//
//       // cuadro 3 -> FP - CANTIDAD DE ALUMNOS Y HORAS CÁTEDRA EN CURSOS DE FORMACIÓN PROFESIONAL
//       //

      $ncuadro=3;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'CANTIDAD DE ALUMNOS Y HORAS CÁTEDRA EN CURSOS DE FORMACIÓN PROFESIONAL',
                                              'descripcion'=>'CANTIDAD DE ALUMNOS Y HORAS CÁTEDRA EN CURSOS DE FORMACIÓN PROFESIONAL',
                                              'c_tipo_cuadro'=>2,
                                              'c_criterio_completitud'=>1 , // NO puede no TENER DATOS
                                              'ancho'=>600, 
                                              'filas'=>4,
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Certificación', 'rowspan'=>2,'titulo'=>true,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
...
//$CN->def_cuadro_store(['c_mapa'=>142], ['celdas'=> [[4,5],[4,6]] ]);
      ...
      //
      // // cuadro 4 FP, NOMENCLATURA CATASTRAL
      //
      $ncuadro=4;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
static public function F2018_CEC($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - CENTRO EDUCATIVO COMPLEMENTARIO';
      $F->nombre_corto='CENTRO ED. COMPLEMENTARIO';
      $F->descripcion='Planilla Relevamiento Final 2018 de C.E.C.';
      $F->id_periodo='82';
      $F->color='f_amarillo';
...
// //       //
     ...
     //fila 2
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 116, [116],'F2018 - c.e.c. cuadro 4') ;
    ...
    $CN->consistencia_cantidad_x_cuadro(4); // por si hay que eliminar consistencias viejas
      ...
      //
      // // cuadro 5 CEC, NOMENCLATURA CATASTRAL
      //
      $ncuadro=5;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
static public function F2018_CEF($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - CENTRO EDUCACIÓN FÍSICA';
      $F->nombre_corto='CENTRO ED. FÍSICA';
      $F->descripcion='Planilla Relevamiento Final 2018 de C.E.F.';
      $F->id_periodo='82';
      $F->color='f_amarillo';
...
// //
    ...
    $CN->consistencia_cantidad_x_cuadro(3); // por si hay que eliminar consistencias viejas
      ...
      //
      // // cuadro 4 -> C.E.F., NOMENCLATURA CATASTRAL
      //
      $ncuadro=4;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                              'nombre'=>'NOMENCLATURA CATASTRAL',
...
static public function F2018_CIIE($id_definicion_formulario)
    {
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA FINAL 2018 - CIIE';
      $F->nombre_corto='CIIE';
      $F->descripcion='Planilla Relevamiento Final 2018 de CIIE';
      $F->id_periodo='82';
      $F->color='f_verde';
...
// //
    ...
    $CN->consistencia_cantidad_x_cuadro(3); // por si hay que eliminar consistencias viejas
      ...
      //
      // // cuadro 5 CIIE, NOMENCLATURA CATASTRAL
      //
      $ncuadro=5;
      $F->def_formulario_add_cuadro ( [  
          'numero'=>$ncuadro,
