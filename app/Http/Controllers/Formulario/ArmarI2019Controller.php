...
class ArmarI2019Controller extends Controller
{
...
static public function I2019()
    {
       ...
       // dd('Lanzar creación de formularios Inicial 2019');

        // $F=ArmarI2019Controller::I2019_INICIAL(30);
        // $F=ArmarI2019Controller::I2019_PRIMARIA(31);
        //$F=ArmarI2019Controller::I2019_SECUNDARIA(32); 
        // $F=ArmarI2019Controller::I2019_SUPERIOR(33); 
        // $F=ArmarI2019Controller::I2019_EPA(34); 
        $F=ArmarI2019Controller::I2019_CENS(35);
        // $F=ArmarI2019Controller::I2019_ESPECIAL(36); 
        // $F=ArmarI2019Controller::I2019_ARTISTICA(37); 
        // $F=ArmarI2019Controller::I2019_FP(38);
        // $F=ArmarI2019Controller::I2019_CEC(39);        
        // $F=ArmarI2019Controller::I2019_CEF(40);        
        // $F=ArmarI2019Controller::I2019_CIIE(41);


        // $F=ArmarI2019Controller::modif_Secundaria ();
...
///////////////////////////////
      ...
      $F = new DefinicionFormularioController( 32);  // crear o cargar el formular
      $CN = $F->cuadros[3];
...
//dd($F); 
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN INICIAL';
      $F->nombre_corto='ED. INICIAL';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de Ed. inicial';
      $F->id_periodo='83';
      $F->color='f_celeste';
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2019 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2019 - inicial cuadro 4') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2019 - inicial cuadro 4') ;
...
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'I2019 - inicial cuadro 5') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'I2019 - inicial cuadro 5') ;
...
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'I2019 - inicial cuadro 6') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'I2019 - inicial cuadro 6') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN PRIMARIA';
      $F->nombre_corto='ED. PRIMARIA';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de Ed. Primaria';
      $F->id_periodo='83';
      $F->color='f_celeste';
...
//
      ...
      $CN->mapacuadro_store_c_mapa ( 100, [100],'I2019 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 101, [101],'I2019 - inicial cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1100, [100,101],'I2019 - inicial cuadro 5') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - primaria cuadro 6') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - primaria cuadro 7') ;
...
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'I2019 - primaria cuadro 9') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'I2019 - primaria cuadro 9') ;
    $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - primaria cuadro 9') ;
...
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'I2019 - primaria 10 j. mat') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'I2019 - primaria 10 j. inf.') ;
    $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - primaria 10 secundaria') ; 
...
//
    ...
    $CN->mapacuadro_store_c_mapa ( 100, [100],'I2019 - primaria cuadro 11') ;
    $CN->mapacuadro_store_c_mapa ( 101, [101],'I2019 - primaria cuadro 11') ;
    $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - primaria cuadro 11') ;
...
//
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 102, [102],'I2019 - primaria cuadro 6') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN SECUNDARIA / POLIMODAL / MEDIA';
      $F->nombre_corto='ED. SECUNDARIA';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de Ed. Secundaria';
      $F->id_periodo='83';
      $F->color='f_celeste';
...
//
    ...
    // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - secundaria cuadro 2') ;
...
//
    ...
    // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - secundaria cuadro 3') ;
...
//
    ...
    // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - secundaria cuadro 5') ; //110=Común - Secundaria Completa req. 6 años 
...
//
    ...
    // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 112, [112],'I2019 - secundaria cuadro 5') ;  //112=Común - Polimodal
...
//
    ...
    $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - secundaria cuadro 16') ;
    $CN->mapacuadro_store_c_mapa ( 112, [112],'I2019 - secundaria cuadro 16') ;
    $CN->mapacuadro_store_c_mapa ( 144, [144],'I2019 - secundaria cuadro 16') ;
    $CN->mapacuadro_store_c_mapa ( 144, [144],'I2019 - secundaria cuadro 16') ;
...
//
    ...
    $CN->mapacuadro_store_c_mapa ( 110, [110],'I2019 - secundaria cuadro 17') ;
    $CN->mapacuadro_store_c_mapa ( 112, [112],'I2019 - secundaria cuadro 17') ;
    $CN->mapacuadro_store_c_mapa ( 144, [144],'I2019 - secundaria cuadro 17') ;
    $CN->mapacuadro_store_c_mapa ( 144, [144],'I2019 - secundaria cuadro 17') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN SUPERIOR';
      $F->nombre_corto='ED. SUPERIOR';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de Ed. Superior';
      $F->id_periodo='83';
      $F->color='f_verde';
...
// //       //
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 115, [115],'I2019 - SUPERIOR cuadro 5') ;
      $CN->mapacuadro_store_c_mapa ( 117, [117],'I2019 - SUPERIOR cuadro 5') ;
      $CN->mapacuadro_store_c_mapa (1115, [115,117],'I2019 - SUPERIOR cuadro 5') ;
...
///////////////////////////////
        ...
        $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN PRIMARIA DE ADULTOS';
        $F->nombre_corto='ED. PRIMARIA DE ADULTOS';
        $F->descripcion='Planilla Relevamiento Inicial 2019 de EPA';
        $F->id_periodo='83';
        $F->color='f_violeta';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN SECUNDARIA DE ADULTOS (CENS/CEBAS)';
      $F->nombre_corto='ED. DE ADULTOS CENS/CEBAS';
      $F->descripcion='Planilla Relevamiento Inicial 2019 de CENS/CEBAS';
      $F->id_periodo='83';
      $F->color='f_violeta';
...
//
//       // cuadro 5 CENS-> CANTIDAD DE ALUMNOS DE MODALIDAD SEMIPRESENCIAL Resol. 737/07
//
...
//
// //   cuadro 6 CENS-> CANTIDAD DE SECCIONES SEGÚN MODO DE DICTADO Y AÑO
//
      $ncuadro=6;
      $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
      ...
      $CN->def_cuadro_store(['valor_inicial'=>'Bachillerato de adultos,  Semipresencial Resol. 737/07' , 'titulo'=>true,'estilos'=>'titulo2', 'tipo_dato'=>'text'], ['celdas'=> [[4,1]] ]);

      
      // AREA DE DATOS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>true,'tipo_dato'=>'number','c_mapa'=>144] , ['region'=> [ [2,2 ,4,7]] ]);

      // SOMBREAR CELDAS
      $CN->def_cuadro_store(['valor_inicial'=>'', 'editable'=>false,'tipo_dato'=>'number'],
                            [ 'celdas'=>[[3,6]], 'region'=>[[2,5,2,6],[4,2,4,5]] ] );

      $CN->def_cuadro_save() ;

      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2019 - CENS cuadro 6') ;
      ...
      $CN->consistencia_save( [
                ...
                'cmp2' => [ 'sei' =>[ 
                                      [[[6,2,2]],   //secciones independientes 1 años de BAO DE 3 AÑOSE PRESENCIAL
                                       [[6,2,3]],   //secciones independientes 2 años de BAO DE 3 AÑOS PRESENCIAL
                                       [[6,2,4]],   //secciones independientes 3 años de BAO DE 3 AÑOS PRESENCIAL
                                      ], //secciones independientes de BAO DE 3 AÑOS PRESENCIAL
                                      [[[6,3,2]],   //secciones independientes 1 años de BAO DE 4 AÑOSE PRESENCIAL
                                       [[6,3,3]],   //secciones independientes 2 años de BAO DE 4 AÑOS PRESENCIAL
                                       [[6,3,4]],   //secciones independientes 3 años de BAO DE 4 AÑOS PRESENCIAL
                                       [[6,3,5]],   //secciones independientes 3 años de BAO DE 4 AÑOS PRESENCIAL
                                      ], //secciones independientes de BAO DE 3 AÑOS PRESENCIAL

                                      [[[6,4,6]],   //secciones independientes SEMIPRESENCIAL
      ...
      $CN->consistencia_save( [
                ...
                'cmp1' => [ 'num' =>[ 
                                      ...
                                      [[5,0,2 ],[5,0,3 ]], //alumnos de cuadro 4 mod. semipresencial
                                    ],

                            'div' =>[ [[6,2,2]], [[6,2,3]], [[6,2,4]],  //secc. 1,2,3, + AG ° año, de carreras
                                      [[6,3,2]], [[6,3,3]], [[6,3,4]], [[6,3,5]],  //secc. 1,2,3,4 + AG ° año
                                      [[6,4,6]], //secc. 1,2,3,4,5 + AG ° año, de cursos                                   
                                    ]
                          ],
...
//
// //       // cuadro 7 CENS-> CANTIDAD DE ALUMNOS Y COMISIONES DE PLANES FINES
// 
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 144, [144],'I2019 - CENS cuadro 5') ;
      ...
      $CN->consistencia_save( [
                ...
                'msg3' => '',    
                'descripcion' => 'CENS -cuadro 7, Total x fila <> suma de AÑOS'
                ] );
      ...
      $CN->consistencia_save( [
                ...
                'c_estado' =>  1, // Consistencia activa
                'cmp1' => [ 'alu' =>[ 
                                      [[[7,2,2],[7,2,3]], //alumnos Línea deudores de materias V+M
                                       [[7,3,2],[7,3,3]], //alumnos Línea trayectos educativos V+M
                                      ]
                                    ]
                          ],
                'cmp2' => [ 'sei' =>[ 
                                      [[[7,2,5]],   //secciones Línea deudores de materias
                                       [[7,3,5]],   //secciones Línea trayectos educativos
      ...
      $CN->consistencia_save( [
                ...
                'c_estado' =>  1, // Consistencia activa
                'cmp1' => [ 'num' =>[ 
                                      [[7,2,2 ],[7,2,3 ]], //alumnos 1
                                      [[7,3,2 ],[7,3,3 ]], //alumnos 2
                                    ],

                            'div' =>[ [[7,2,5]], //secc. 1, + AG ° año, 
                                      [[7,3,5]], //secc. 2, + AG ° año                                   
                                    ]
                          ],
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN ESPECIAL';
      $F->nombre_corto='ED. ESPECIAL';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de Especial';
      $F->id_periodo='83';
      $F->color='f_rosa';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - EDUCACIÓN ARTÍSTICA';
      $F->nombre_corto='ED. ARTÍSTICA';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de Artistica';
      $F->id_periodo='83';
      $F->color='f_marron';
...
static public function I2019_FP($id_definicion_formulario)
{
  ...
  ///////////////////////////////
    ...
    $F->nombre='MATRÍCULA INICIAL 2019 - FORMACIÓN PROFESIONAL';
    $F->nombre_corto='FORMACIÓN PROFESIONAL';
    $F->descripcion='Planilla Relevamiento INICIAL 2019 de Formación Profesional';
    $F->id_periodo='83';
    $F->color='f_naranja';
  ...
  //
  // // cuadro 4 -> FP - CANTIDAD DE CURSOS Y SECCIONES

    $ncuadro=4;
    $F->def_formulario_add_cuadro ( [   'numero'=>$ncuadro,
                                            'nombre'=>'CANTIDAD DE CURSOS Y SECCIONES',
                                            'descripcion'=>'cuadro de cursos y secciones',
                                            'indicaciones'=>'ACLARACIÓN: Cada grupo al que se imparte un curso constituye una sección. Si un curso tiene dos o más grupos se considera un curso con dos o más secciones.',
                                            'c_tipo_cuadro'=>1,
                                            'c_criterio_completitud'=>1 , // NO puede no TENER DATOS
                                            'filas'=>3,
                                            'ancho'=>465,
    ...
    // TITULOS DE FILAS
    $CN->def_cuadro_store(['valor_inicial'=>'Cursos', 'titulo'=>true,'rowspan'=>2, 'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,1]] ]);
    $CN->def_cuadro_store(['valor_inicial'=>'Secciones', 'titulo'=>true, 'colspan'=>2,'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[1,2]] ]);
    $CN->def_cuadro_store(['valor_inicial'=>'de Sede', 'titulo'=>true, 'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,2]] ]);
    $CN->def_cuadro_store(['valor_inicial'=>'Radiales o Periféricas', 'titulo'=>true, 'estilos'=>'titulo1', 'tipo_dato'=>'text'], ['celdas'=> [[2,3]] ]);
    ...
    $CN->consistencia_save( [
          ...
          'cmp2' => ['col' => [2,3] ] ,
          'cmp3' => ['sig' => '>' ],
          'msg1' => 'La cantidad de cursos ',
          'msg2' => 'no puede superar la cantidad de grupos o secciones',
          'msg3' => '',    
          'descripcion' => 'FP -cuadro 4, cant. cursos > Total  secciones'
          ] );
    ...
    $CN->consistencia_save( [
          ...
          'msg2' => 'informada, no se corresponde con las secciones/grupos declaradas',
          'msg3' => '',    
          'descripcion' => 'comparacion de alumnos varon + mujer con secciones independientes y/ agrupadas'
          ] );
    ...
    $CN->consistencia_save( [
          ...
          'msg1' => 'La relación de alumnos por sección resultante entre los ',
          'msg2' => 'excede los valores habituales, ',
          'msg3' => 'alumnos por sección, verifique la cantidad de alumnos y secciones cargadas, si es correcto ignore esta advertencia',    
          'descripcion' => 'advertencia de alumnos x seccion fuera de rango FP'
          ] );
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - CENTRO EDUCATIVO COMPLEMENTARIO';
      $F->nombre_corto='CENTRO ED. COMPLEMENTARIO';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de C.E.C.';
      $F->id_periodo='83';
      $F->color='f_amarillo';
...
// //       //
     ...
     //fila 2
      ...
      // DEFINIR mapa_cuadro DEL CUADRO
      $CN->mapacuadro_store_c_mapa ( 116, [116],'I2019 - c.e.c. cuadro 4') ;
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - CENTRO EDUCACIÓN FÍSICA';
      $F->nombre_corto='CENTRO ED. FÍSICA';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de C.E.F.';
      $F->id_periodo='83';
      $F->color='f_amarillo';
...
///////////////////////////////
      ...
      $F->nombre='MATRÍCULA INICIAL 2019 - CIIE';
      $F->nombre_corto='CIIE';
      $F->descripcion='Planilla Relevamiento INICIAL 2019 de CIIE';
      $F->id_periodo='83';
      $F->color='f_verde';
