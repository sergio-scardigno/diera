    ...
    'assets' => [
        ...
        'highcharts' => [
            'styles' => [
                ...
                // 'https://cdnjs.cloudflare.com/ajax/libs/highcharts/7.1.1/css/highcharts.css',
            ],
            'scripts' => [
                // 'https://cdnjs.cloudflare.com/ajax/libs/highcharts/5.0.7/highcharts.js',
                'https://cdnjs.cloudflare.com/ajax/libs/highcharts/7.1.1/highcharts.js',
                // 'https://cdnjs.cloudflare.com/ajax/libs/highcharts/5.0.7/js/modules/offline-exporting.js',
                'https://cdnjs.cloudflare.com/ajax/libs/highcharts/7.1.1/modules/offline-exporting.js',
